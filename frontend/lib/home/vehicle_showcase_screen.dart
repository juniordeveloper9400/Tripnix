...
class _ExploreTabState extends State<_ExploreTab> {
  ...
  final List<String> _categories = ['Car', 'All', 'Bus'];
  final List<Story> _stories = sampleStories();
  ...
  List<Vehicle> get _filteredVehicles {
    return _allVehicles.where((v) {
      final matchesCategory = _selectedCategory == 'All' || v.type.toLowerCase() == _selectedCategory.toLowerCase();
    ...
    return Scaffold(
      body: RefreshIndicator(
        ...
        child: CustomScrollView(
          ...
          slivers: [
            // Stories row - latest trips posted by bus admins (at the very top)
            SliverSafeArea(
              bottom: false,
              sliver: SliverToBoxAdapter(
                child: StoriesBar(stories: _stories),
              ),
            ),
            ...
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.event_available, size: 18, color: AppColors.red),
            ...
            if (_isLoading)
              ...
              SliverFillRemaining(
                hasScrollBody: false,
                child: _ErrorState(error: _errorMessage!, onRetry: _fetchVehicles),
              )
