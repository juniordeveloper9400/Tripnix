...
The yearly platform fee is paid on the Tripnix site. See the Subscription page for the link.`),me("subscription");return}Re()}),at.addEventListener("click",G),ot.addEventListener("click",G),(n=document.getElementById("diary-add-btn"))==null||n.addEventListener("click",()=>ge()),(o=document.getElementById("diary-modal-close"))==null||o.addEventListener("click",de),(i=document.getElementById("diary-modal-cancel"))==null||i.addEventListener("click",de),(r=document.getElementById("diary-form"))==null||r.addEventListener("submit",Ct),(s=document.getElementById("acc-month"))==null||s.addEventListener("change",x=>_(x.target.value)),(d=document.getElementById("acc-add-btn"))==null||d.addEventListener("click",ut),(u=document.getElementById("acc-entry-close"))==null||u.addEventListener("click",se),(v=document.getElementById("acc-entry-cancel"))==null||v.addEventListener("click",se),(p=document.getElementById("acc-entry-form"))==null||p.addEventListener("submit",gt),document.querySelectorAll('input[name="acc-kind"]').forEach(x=>x.addEventListener("change",M=>Ae(M.target.value))),(m=document.getElementById("diary-from"))==null||m.addEventListener("change",x=>{const M=document.getElementById("diary-to");M&&(!M.value||M.value<x.target.value)&&(M.value=x.target.value)}),document.querySelectorAll(".filter-chips .chip[data-filter]").forEach(x=>{x.addEventListener("click",()=>{document.querySelectorAll(".filter-chips .chip[data-filter]").forEach(M=>M.classList.remove("active")),x.classList.add("active"),l.fleetFilter=x.getAttribute("data-filter"),l.seatFilter="All",renderFleetSeatFilterChips(),U()})}),document.getElementById("fleet-search").addEventListener("input",x=>{l.searchQuery=x.target.value,U()}),(f=document.getElementById("vehicle-number"))==null||f.addEventListener("input",x=>{x.target.value=x.target.value.toUpperCase()}),De.addEventListener("submit",Kt),(g=document.getElementById("upload-images-btn"))==null||g.addEventListener("click",()=>{var x;(x=document.getElementById("vehicle-images-input"))==null||x.click()}),(b=document.getElementById("upload-videos-btn"))==null||b.addEventListener("click",()=>{var x;(x=document.getElementById("vehicle-videos-input"))==null||x.click()}),(k=document.getElementById("vehicle-images-input"))==null||k.addEventListener("change",Et),(w=document.getElementById("vehicle-videos-input"))==null||w.addEventListener("change",xt),(L=document.getElementById("vehicle-type"))==null||L.addEventListener("change",j),(S=document.getElementById("vehicle-capacity"))==null||S.addEventListener("input",j),ie&&ie.addEventListener("submit",Rt),(E=document.getElementById("pricing-form"))==null||E.addEventListener("submit",jt),(N=document.getElementById("trip-form"))==null||N.addEventListener("submit",Nt),(he=document.getElementById("trip-image-btn"))==null||he.addEventListener("click",()=>{var x;(x=document.getElementById("trip-image-input"))==null||x.click()}),(ve=document.getElementById("trip-image-input"))==null||ve.addEventListener("change",Tt),wt()}function wt(){const e=document.getElementById("vehicle-type-dropdown"),t=document.getElementById("vehicle-type-trigger"),a=document.getElementById("vehicle-type-menu"),n=document.getElementById("vehicle-type"),o=document.getElementById("selected-type-icon"),i=document.getElementById("selected-type-text"),r=a==null?void 0:a.querySelectorAll(".custom-dropdown-item");if(!t||!a||!n)return;const s={Bus:"🚌",Traveller:"🚐",Car:"🚗"},d={Bus:[{label:"12 Seats",value:12},{label:"22 Seats",value:22},{label:"36 Seats",value:36},{label:"49 Seats",value:49},{label:"Above 49 Seats",value:50,isAbove:!0}],Traveller:[{label:"12 Seats",value:12},{label:"14 Seats",value:14},{label:"16 Seats",value:16},{label:"18 Seats",value:18}],Car:[{label:"4 Seats",value:4},{label:"7 Seats",value:7},{label:"8 Seats",value:8}]};function u(p){var w;const m=document.getElementById("vehicle-seat-options"),f=document.getElementById("vehicle-capacity");if(!m||!f)return;const g=p||((w=document.getElementById("vehicle-type"))==null?void 0:w.value)||"Bus",b=d[g]||d.Bus,k=Number(f.value)||0;m.innerHTML=b.map(L=>`
      <button type="button" class="seat-option-pill${(L.isAbove?k>49:k===L.value)?" active":""}"
        ...
        ${c(L.label)}
      </button>`).join("")}window.selectVehicleSeatPill=function(p,m){const f=document.getElementById("vehicle-capacity");f&&(f.value=p,u(),j())};function v(){const p=document.getElementById("seat-filter-chips");if(!p)return;const m=l.fleetFilter,f=d[m];if(!f||!f.length){p.innerHTML="",l.seatFilter="All";return}p.innerHTML=`
...
Add ${window.location.origin} to the bucket's CORS policy in the Cloudflare dashboard (R2 → tripnix → Settings → CORS), or upload a smaller file.`)}if(!r.ok)throw new Error(`Direct upload to R2 failed (${r.status}).`);return i.url}function Y(e){return Number.isFinite(e)?e>=1048576?`${(e/1048576).toFixed(1)} MB`:`${Math.max(1,Math.round(e/1024))} KB`:"—"}async function Fe(e,t,a){const n=Array.from(e.target.files||[]);if(!n.length)return;const o=document.getElementById("media-upload-status"),i=r=>{o&&(o.textContent=r)};try{for(let r=0;r<n.length;r++){const s=n[r];i(`Uploading ${r+1} of ${n.length} — ${s.name} (${Y(s.size)})…`);const d=await Pe(s,t);l[a].push(d),R()}i("")}catch(r){i(""),alert("❌ "+r.message)}finally{e.target.value=""}}function Et(e){return Fe(e,"vehicles/images","vehicleFormImages")}function xt(e){return Fe(e,"vehicles/videos","vehicleFormVideos")}function R(){const e=document.getElementById("images-preview-grid"),t=document.getElementById("videos-preview-grid");e&&(e.innerHTML=l.vehicleFormImages.map((a,n)=>`
    ...
    `).join(""))}window.removeFormImage=function(e){l.vehicleFormImages.splice(e,1),R()};window.removeFormVideo=function(e){l.vehicleFormVideos.splice(e,1),R()};async function D(){var e;try{const[t,a]=await Promise.all([fetch(`${h}/vehicles`),fetch(`${h}/bookings`)]);if(!t.ok||!a.ok)throw new Error("API error");const n=await t.json(),o=await a.json();if(l.currentUser&&l.currentUser.role!=="superadmin"){const i=l.currentUser.operatorName.toLowerCase();l.vehicles=n.filter(r=>r.operatorName.toLowerCase()===i),l.bookings=o.filter(r=>r.operatorName&&r.operatorName.toLowerCase()===i)}else l.vehicles=n,l.bookings=o;zt(),U(),qt(),await Z(),await J(),((e=l.currentUser)==null?void 0:e.role)==="superadmin"&&await Q()}catch(t){console.error("Load error:",t),alert("Cannot connect to backend (http://localhost:3000). Please start the backend first.")}}async function ue(){var t,a,n;await D();const e=document.getElementById("diary-list");e&&(e.innerHTML='<p class="diary-empty">Loading agency diary…</p>');try{const o=((t=l.currentUser)==null?void 0:t.operatorName)||"",i=await fetch(`${h}/trips/agency-diary?operatorName=${encodeURIComponent(o)}`);if(!i.ok)throw new Error("Could not load agency diary");l.agencyDiaryData=await i.json();const r=((a=l.agencyDiaryData)==null?void 0:a.entries)||[],s=new Set;r.forEach(d=>{if(d.status==="Completed"||!d.departureDate||!d.arrivalDate)return;let u=new Date(`${d.departureDate}T00:00:00`);const v=new Date(`${d.arrivalDate}T00:00:00`);for(;u<=v;)s.add(u.toISOString().slice(0,10)),u.setDate(u.getDate()+1)}),l.diary={entries:r,latestTrip:((n=l.agencyDiaryData)==null?void 0:n.latestTrip)||null,bookedDates:Array.from(s)}}catch(o){l.diary=null,e&&(e.innerHTML=`<p class="diary-empty">❌ ${c(o.message)}</p>`);return}It()}function It(){Bt(),kt(),Lt()}function Bt(){var n;const e=document.getElementById("latest-diary-trip-container");if(!e)return;const t=(n=l.diary)==null?void 0:n.latestTrip;if(!t){e.innerHTML=`
    ...
    </div>`}function kt(){const e=document.getElementById("diary-list"),t=document.getElementById("diary-summary");if(!e)return;const a=l.diary;if(!a){e.innerHTML="",t&&(t.innerHTML="");return}const n=a.entries.filter(r=>r.status!=="Completed"),o=a.entries.filter(r=>r.kind==="diary"),i=o.reduce((r,s)=>r+Number(s.fare||0),0);if(t&&(t.innerHTML=`
    ...
    <tr>
      ...
      <td>
        <span class="badge-status ${St(n.status)}">${c(n.status)}</span>
...
${a||""}`),i();document.getElementById("notice-icon").textContent=e,document.getElementById("notice-title").textContent=t,document.getElementById("notice-lead").textContent=a||"",document.getElementById("notice-lines").innerHTML=n.map(u=>`<div><dt>${c(u.label)}</dt><dd>${u.value}</dd></div>`).join("");const s=document.getElementById("notice-ok");s.textContent=o;const d=()=>{r.classList.add("hidden"),s.removeEventListener("click",d),i()};s.addEventListener("click",d),r.classList.remove("hidden")})}function je(){const e=V(I()+1);if(!e)return null;const t=z();return!t||t.status!=="active"?{tier:e,charge:e.price,upgrade:!1}:t.tierId===e.tierId?{tier:e,charge:0,upgrade:!1}:{tier:e,charge:Math.max(0,e.price-(t.price||0)),upgrade:!0}}function T(){var e;return((e=l.plans)==null?void 0:e.billingPeriod)||"month"}function ye(){var e,t;return((t=(e=l.subscription)==null?void 0:e.platform)==null?void 0:t.status)==="active"}function Mt(){l.plans&&(At(),Ft(),Pt(),Ot(),Ht(),Ut())}function At(){var g;const e=l.plans.platform,t=(g=l.subscription)==null?void 0:g.platform,a=ye(),n=window.location.origin.includes("3005")?"http://localhost:3000/":window.location.origin+"/";document.getElementById("membership-title").textContent=e.name;const o=e.plans||[],i=o.find(b=>b.id===(t==null?void 0:t.planId)),r=o.reduce((b,k)=>b&&b.price<=k.price?b:k,o[0]),s=i||r;document.getElementById("membership-price").textContent=s?`${y(s.price)} / ${s.period}`:y(e.price);const d=document.querySelector(".membership-price-label");d&&(d.textContent=i?"Your platform plan":"Platform fee from"),document.getElementById("membership-benefits").innerHTML=e.features.map(b=>`<li>${c(b)}</li>`).join("");const u=document.getElementById("membership-badge"),v=document.getElementById("membership-card"),p=document.getElementById("membership-status-line"),m=document.getElementById("membership-managed-note");v.classList.toggle("is-active",a),document.getElementById("membership-start").textContent=B(t==null?void 0:t.startsAt),document.getElementById("membership-expiry").textContent=B(t==null?void 0:t.expiresAt),document.getElementById("membership-remaining").textContent=t&&a?`${t.daysLeft} days`:"—",document.getElementById("membership-paid").textContent=t?y(t.amount):"—",a?(u.className="badge-status confirmed",u.textContent="ACTIVE",p.textContent=`${l.subscription.operatorName} is registered. You can add vehicles and browse other agencies' fleets.`,m.innerHTML=`🔒 Managed on the Tripnix site — renew at <a href="${n}" target="_blank" rel="noopener">${n}</a> before it expires.`):t?(u.className="badge-status cancelled",u.textContent="EXPIRED",p.textContent="Your membership has lapsed, so your fleet is hidden from travellers.",m.innerHTML=`⚠️ Renew on the Tripnix site to go live again: <a href="${n}" target="_blank" rel="noopener">${n}</a>`):(u.className="badge-status pending",u.textContent="NOT REGISTERED",p.textContent=e.tagline,m.innerHTML=`⚠️ Pay the platform fee on the Tripnix site to activate your agency: <a href="${n}" target="_blank" rel="noopener">${n}</a>`);const f=document.getElementById("subscription-badge");f&&(f.style.display=a?"none":"inline-block")}function Pt(){var n;const e=l.plans?document.getElementById("plan-grid"):null;if(!e)return;const t=l.plans.fleetTiers||[];if(!t.length){e.innerHTML='<p class="plan-empty">No fleet plan configured.</p>';return}const a=(n=V(I()))==null?void 0:n.id;e.innerHTML=`
    ...
    </div>`}function Ft(){var n,o,i,r;const e=document.getElementById("platform-plan-options");if(!e)return;const t=((o=(n=l.plans)==null?void 0:n.platform)==null?void 0:o.plans)||[];if(!t.length){e.innerHTML="";return}const a=(r=(i=l.subscription)==null?void 0:i.platform)==null?void 0:r.planId;e.innerHTML=t.map(s=>`
    ...
    </tr>`).join("")}function Ut(){const e=ye();re.title=e?"Add a vehicle to your fleet":"Pay the platform fee first to start adding vehicles",re.classList.toggle("btn-locked",!e)}window.payFleetFee=async function(){var o,i;const e=(o=l.currentUser)==null?void 0:o.operatorName;if(!e)return;const t=V(I());if(!t)return alert("❌ No fleet plan is configured.");const a=fe();if(await Ue({title:a?"Renew Fleet Plan":"Confirm Payment",lead:a?`Extends your fleet plan by another ${T()} from its current expiry.`:"One fee covers every vehicle you run — priced by how many that is.",planName:`${t.label} fleet plan`,planSub:`Covers all ${I()} of your vehicle${I()===1?"":"s"}`,planPrice:y(t.price),lines:[{label:"Plan price",value:`${y(t.price)} / ${T()}`},{label:"Vehicles covered",value:String(I())},...a?[{label:"Extends from",value:B((i=z())==null?void 0:i.expiresAt)}]:[]],total:y(t.price),actionLabel:a?`Renew · ${y(t.price)}`:`Pay ${y(t.price)}`}))try{const r=await fetch(`${h}/subscriptions/fleet`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({operatorName:e,vehicleCount:I()})}),s=await r.json();if(!r.ok)throw new Error((s==null?void 0:s.error)||"Payment failed");await Z(),U(),Oe(),await P({icon:a?"🔄":"🎉",title:a?"Fleet plan renewed":"Your fleet is listed!",lead:a?"Your vehicles stay visible to travellers for another period.":"Every vehicle in your fleet is now visible to travellers.",lines:[{label:"Fleet plan",value:c(s.tierLabel)},{label:"Vehicles covered",value:String(I())},{label:"Paid now",value:y(t.price)},{label:"Covered until",value:B(s.expiresAt)}]})}catch(r){alert("❌ "+r.message)}};async function jt(e){e.preventDefault();const t=Number(document.getElementById("price-platform").value),a=[...document.querySelectorAll("#tier-price-inputs input[data-tier-id]")].map(n=>({id:n.dataset.tierId,price:Number(n.value)}));try{const n=await fetch(`${h}/subscriptions/plans`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({platformPrice:t,fleetTiers:a})}),o=await n.json();if(!n.ok)throw new Error((o==null?void 0:o.error)||"Failed to save pricing");await Z(),alert("✅ Plan pricing updated.")}catch(n){alert("❌ "+n.message)}}async function Q(){var e;if(((e=l.currentUser)==null?void 0:e.role)==="superadmin")try{const t=await fetch(`${h}/auth/admins`);if(!t.ok)throw new Error("Failed");l.admins=await t.json(),Vt()}catch(t){console.error("Admins load error:",t)}}async function Rt(e){e.preventDefault();const t=document.getElementById("admin-username").value.trim(),a=document.getElementById("admin-password").value.trim(),n=document.getElementById("admin-operator").value.trim(),o=document.getElementById("admin-phone").value.trim();try{const i=await fetch(`${h}/auth/admins`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:t,password:a,operatorName:n,phone:o})});let r=null;try{r=await i.json()}catch{r=null}if(!i.ok)throw new Error((r==null?void 0:r.error)||"Failed to create account");ie.reset(),await Q(),alert(`✅ Account created!

Travel Agency: ${n}
Username: ${t}
Password: ${a}

Share these credentials with the travel owner.`)}catch(i){alert("❌ "+i.message)}}function Vt(){const e=document.getElementById("admins-table-tbody");if(e){if(!l.admins.length){e.innerHTML='<tr><td colspan="7" style="text-align:center;color:var(--text-muted);padding:24px;">No travel owner accounts yet.</td></tr>';return}e.innerHTML=l.admins.map(t=>`
    <tr>
      <td>#${t.id}</td>
    ...
    <div class="vehicle-admin-card${a.onHold?" is-held":""}">
    ...
    </div>`}).join("")}function qt(){const e=document.getElementById("all-bookings-tbody"),t=[...l.bookings].reverse();e.innerHTML=t.length?t.map(a=>`
      <tr>
        <td>#${a.id}</td>
      ...
      </tr>`).join(""):'<tr><td colspan="7" style="text-align:center;color:var(--text-muted);padding:32px;">No bookings found.</td></tr>'}let $=null;function Yt(){const e=document.getElementById("vehicle-dates");e&&typeof flatpickr<"u"&&!$&&($=flatpickr(e,{mode:"multiple",dateFormat:"Y-m-d",conjunction:", ",theme:"dark",monthSelectorType:"dropdown",onChange:t=>{X(t)}}),Gt())}function X(e){const t=document.getElementById("selected-date-chips"),a=document.getElementById("selected-dates-count");if(!t)return;const n=(e||[]).map(o=>{if(o instanceof Date){const i=o.getFullYear(),r=String(o.getMonth()+1).padStart(2,"0"),s=String(o.getDate()).padStart(2,"0");return`${i}-${r}-${s}`}return String(o).trim()}).filter(Boolean).sort();if(a&&(a.textContent=`${n.length} date${n.length===1?"":"s"} selected`),n.length===0){t.innerHTML='<span class="no-dates-text">No dates selected yet. Click input or presets above to select dates.</span>';return}t.innerHTML=n.map(o=>`
