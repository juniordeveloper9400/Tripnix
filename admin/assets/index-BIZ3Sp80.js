(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=a(o);fetch(o.href,i)}})();const ve="tripnix-fleet-map-styles";function K(e){return e?String(e.place||e.placeName||e.label||"").trim():""}let F=null;function Ee(){var e;return(e=window.L)!=null&&e.map?Promise.resolve(window.L):F||(F=new Promise((t,a)=>{if(!document.getElementById("leaflet-css")){const o=document.createElement("link");o.id="leaflet-css",o.rel="stylesheet",o.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",document.head.appendChild(o)}const n=document.createElement("script");n.src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js",n.async=!0,n.onload=()=>{var o;return(o=window.L)!=null&&o.map?t(window.L):a(new Error("Leaflet loaded but unavailable"))},n.onerror=()=>a(new Error("Could not load the map library")),document.head.appendChild(n)}).catch(t=>{throw F=null,t}),F)}function ae(e,t,a,n){return e.divIcon({className:"fmap-pin-wrap",iconSize:[40,52],iconAnchor:[20,46],popupAnchor:[0,-44],html:`
      ...
      ${i?"<br><em>Sample position</em>":""}`;let x=s.markers.get(p.vehicleId);x?(x.setLatLng([m.lat,m.lng]),x.setIcon(ae(s.L,p,g,i)),x.setPopupContent(v)):(x=s.L.marker([m.lat,m.lng],{icon:ae(s.L,p,g,i)}).addTo(s.map).bindPopup(v),s.markers.set(p.vehicleId,x))}for(const[p,m]of s.markers)d.has(p)||(m.remove(),s.markers.delete(p));!s.framed&&u.length&&(u.length===1?s.map.setView(u[0],12):s.map.fitBounds(u,{padding:o?[30,30]:[55,55]}),s.framed=!0),setTimeout(()=>s.map.invalidateSize(),60);const b=t.total-a.length;return e.querySelector(".fmap-legend").innerHTML=i?`<span><i style="background:#fab219"></i>Sample data</span>
  ...
  `,document.head.appendChild(e)}function S(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function We(e,t,{noteEl:a,compact:n}){const{lat:o,lng:i,zoom:r}=Ye,s=`https://www.google.com/maps?q=${o},${i}&hl=en&z=${r}&output=embed`;a&&(a.textContent=t.total?"No bus has reported a position yet":""),e.innerHTML=`
    <div class="fmap fmap-live${n?" is-compact":""}">
    ...
    </div>`}function q(e,t,a,{noteEl:n,compact:o,sample:i=!1}){const r=Number(e.dataset.fleetMapBus),s=a.find(m=>m.vehicleId===r)||a.find(m=>m.location.live)||a[0];e.dataset.fleetMapBus=String(s.vehicleId);const d=s.location,u=`https://www.google.com/maps?q=${d.lat},${d.lng}&hl=en&z=${o?13:14}&output=embed`,b=a.map(m=>{const g=m.vehicleId===s.vehicleId,f=m.location.live;return`
      <button type="button" class="fmap-chip${g?" is-on":""}"
        ...
        <span>${f?"live":m.location.ageMinutes+"m"}</span>
    ...
    </div>`,e.querySelectorAll("[data-fleet-map-bus]").forEach(m=>m.addEventListener("click",()=>{e.dataset.fleetMapBus=m.dataset.fleetMapBus,q(e,t,a,{noteEl:n,compact:o,sample:i})})),n){const m=K(d);n.textContent=i?`Sample positions · showing ${s.vehicleNumber||s.vehicleName}${m?" near "+m:""}`:`${t.reporting} of ${t.total} reporting · showing ${s.vehicleNumber||s.vehicleName}${m?" near "+m:""}`}}async function Ge(e,t,a,{noteEl:n,compact:o,apiKey:i}){let r;try{r=await qe(i)}catch(g){return console.warn("[fleet-map]",g.message),!1}let s=M.get(e);if(!s){e.innerHTML=`<div class="fmap fmap-live${o?" is-compact":""}"><div class="fmap-canvas"></div></div>`;const g=e.querySelector(".fmap-canvas");s={map:new r.Map(g,{center:{lat:a[0].location.lat,lng:a[0].location.lng},zoom:12,mapTypeControl:!o,streetViewControl:!1,fullscreenControl:!o,zoomControl:!0,backgroundColor:"#eef1f5",gestureHandling:"cooperative"}),markers:new Map,info:new r.InfoWindow},M.set(e,s)}const d=new Set,u=new r.LatLngBounds;for(const g of a){const f=g.location,v=f.live?"#0ca30c":"#fab219",x={lat:f.lat,lng:f.lng};u.extend(x),d.add(g.vehicleId);const I=g.vehicleNumber||g.vehicleName,L=K(f),T=`${f.live?"Live now":f.ageMinutes+" min ago"}${L?" · "+S(L):""}${f.speedKph?" · "+Math.round(f.speedKph)+" km/h":""}`;let $=s.markers.get(g.vehicleId);$?($.setPosition(x),$.setIcon({url:oe(v),scaledSize:new r.Size(34,43),anchor:new r.Point(17,43)})):($=new r.Marker({map:s.map,position:x,title:`${g.vehicleName} · ${T.replace(/<[^>]*>/g,"")}`,icon:{url:oe(v),scaledSize:new r.Size(34,43),anchor:new r.Point(17,43)},zIndex:f.live?2:1}),s.markers.set(g.vehicleId,$)),$.addListener("click",()=>{s.info.setContent(`<div style="font-family:system-ui;color:#0b1220;min-width:150px">
           <strong style="font-size:13px">${S(g.vehicleName)}</strong><br>
    ...
    <p class="panel-header-note" style="margin-top:10px;line-height:1.6;">
      ...
      the owner in the Owner Portal.
        ...
        </div>`).join(""):'<p class="diary-empty">Nothing recorded for this month yet. Use ➕ Add entry to record fuel, wages, servicing or extra income.</p>'}const gt=2e4;let H=null;function ft(){me(),le(),H=setInterval(()=>{document.hidden||le()},gt)}function me(){H&&clearInterval(H),H=null}document.addEventListener("visibilitychange",()=>{!document.hidden&&H&&le()});async function le(){var t;const e=(t=l.currentUser)==null?void 0:t.operatorName;if(e)try{if(l.mapsApiKey===void 0){const n=await fetch(`${h}/tracking/config`).catch(()=>null),o=n!=null&&n.ok?await n.json():null;l.mapsApiKey=(o==null?void 0:o.mapsApiKey)||""}const a=await fetch(`${h}/tracking?operatorName=${encodeURIComponent(e)}`);if(!a.ok)throw new Error("Could not load tracking");l.tracking=await a.json(),yt()}catch(a){if(l.tracking)return;document.getElementById("gps-list").innerHTML=`<p class="diary-empty">❌ ${c(a.message)}</p>`}}function yt(){const e=l.tracking;if(!e)return;const{vehicles:t,sample:a}=Ve(e);Ke(document.getElementById("gps-map"),e,{noteEl:document.getElementById("gps-map-note"),apiKey:l.mapsApiKey}),document.getElementById("gps-note").textContent=a?`Sample positions · live for ${e.staleAfterMinutes} minutes after the last fix`:`${e.reporting} of ${e.total} reporting · live for ${e.staleAfterMinutes} minutes after the last fix`,document.getElementById("gps-list").innerHTML=t.length?t.map(n=>{const o=n.location,i=a?'<span class="badge-status cancelled">SAMPLE</span>':o?o.live?'<span class="badge-status confirmed">LIVE</span>':`<span class="badge-status cancelled">${o.ageMinutes} MIN AGO</span>`:'<span class="badge-status pending">NO SIGNAL</span>',r=K(o),s=o?`${r?c(r):"Position received, place name not available"}${o.speedKph?" · "+Math.round(o.speedKph)+" km/h":""}`:"This bus has never reported a position",d=o?` · <a href="https://www.google.com/maps?q=${o.lat},${o.lng}" target="_blank" rel="noopener">Open map ↗</a>`:"";return`
          <div class="diary-row gps-row">
            <div class="diary-row-main">
              <strong>${c(n.vehicleName)}</strong>
              <code class="vehicle-number">${c(n.vehicleNumber||"—")}</code>
              <div class="diary-row-who">${s}${d}</div>
              <div class="diary-row-status">${i}</div>
            </div>
            <div class="row-map" data-bus-map="${n.vehicleId}"></div>
          </div>`}).join(""):'<p class="diary-empty">No buses in the fleet yet.</p>';for(const n of t)ze(document.querySelector(`[data-bus-map="${n.vehicleId}"]`),n,{sample:a})}function ht(){var e,t,a,n,o,i,r,s,d,u,b,p,m,g,f,v,x,I,L,T,$,P,ye,he;Le.addEventListener("submit",it),_e.addEventListener("click",st),(e=document.getElementById("sidebar-toggle-btn"))==null||e.addEventListener("click",lt),(t=document.getElementById("sidebar-overlay"))==null||t.addEventListener("click",W),(a=document.getElementById("sidebar-close-btn"))==null||a.addEventListener("click",W),Xe.addEventListener("click",D),re.addEventListener("click",()=>{if(l.subscription&&!fe()){alert(`🔒 Your agency is not registered yet.

The yearly platform fee is paid on the Tripnix site. See the Subscription page for the link.`),ce("subscription");return}je()}),tt.addEventListener("click",G),nt.addEventListener("click",G),(n=document.getElementById("diary-add-btn"))==null||n.addEventListener("click",()=>ue()),(o=document.getElementById("diary-modal-close"))==null||o.addEventListener("click",de),(i=document.getElementById("diary-modal-cancel"))==null||i.addEventListener("click",de),(r=document.getElementById("diary-form"))==null||r.addEventListener("submit",kt),(s=document.getElementById("acc-month"))==null||s.addEventListener("change",E=>_(E.target.value)),(d=document.getElementById("acc-add-btn"))==null||d.addEventListener("click",mt),(u=document.getElementById("acc-entry-close"))==null||u.addEventListener("click",se),(b=document.getElementById("acc-entry-cancel"))==null||b.addEventListener("click",se),(p=document.getElementById("acc-entry-form"))==null||p.addEventListener("submit",pt),document.querySelectorAll('input[name="acc-kind"]').forEach(E=>E.addEventListener("change",N=>Me(N.target.value))),(m=document.getElementById("diary-from"))==null||m.addEventListener("change",E=>{const N=document.getElementById("diary-to");N&&(!N.value||N.value<E.target.value)&&(N.value=E.target.value)}),document.querySelectorAll(".filter-chips .chip[data-filter]").forEach(E=>{E.addEventListener("click",()=>{document.querySelectorAll(".filter-chips .chip[data-filter]").forEach(N=>N.classList.remove("active")),E.classList.add("active"),l.fleetFilter=E.getAttribute("data-filter"),l.seatFilter="All",renderFleetSeatFilterChips(),U()})}),document.getElementById("fleet-search").addEventListener("input",E=>{l.searchQuery=E.target.value,U()}),(g=document.getElementById("vehicle-number"))==null||g.addEventListener("input",E=>{E.target.value=E.target.value.toUpperCase()}),Se.addEventListener("submit",Wt),(f=document.getElementById("upload-images-btn"))==null||f.addEventListener("click",()=>{var E;(E=document.getElementById("vehicle-images-input"))==null||E.click()}),(v=document.getElementById("upload-videos-btn"))==null||v.addEventListener("click",()=>{var E;(E=document.getElementById("vehicle-videos-input"))==null||E.click()}),(x=document.getElementById("vehicle-images-input"))==null||x.addEventListener("change",wt),(I=document.getElementById("vehicle-videos-input"))==null||I.addEventListener("change",$t),(L=document.getElementById("vehicle-type"))==null||L.addEventListener("change",j),(T=document.getElementById("vehicle-capacity"))==null||T.addEventListener("input",j),ie&&ie.addEventListener("submit",Ut),($=document.getElementById("pricing-form"))==null||$.addEventListener("submit",Ht),(P=document.getElementById("trip-form"))==null||P.addEventListener("submit",St),(ye=document.getElementById("trip-image-btn"))==null||ye.addEventListener("click",()=>{var E;(E=document.getElementById("trip-image-input"))==null||E.click()}),(he=document.getElementById("trip-image-input"))==null||he.addEventListener("change",Lt),vt()}function vt(){const e=document.getElementById("vehicle-type-dropdown"),t=document.getElementById("vehicle-type-trigger"),a=document.getElementById("vehicle-type-menu"),n=document.getElementById("vehicle-type"),o=document.getElementById("selected-type-icon"),i=document.getElementById("selected-type-text"),r=a==null?void 0:a.querySelectorAll(".custom-dropdown-item");if(!t||!a||!n)return;const s={Bus:"🚌",Traveller:"🚐",Car:"🚗"},d={Bus:[{label:"12 Seats",value:12},{label:"22 Seats",value:22},{label:"36 Seats",value:36},{label:"49 Seats",value:49},{label:"Above 49 Seats",value:50,isAbove:!0}],Traveller:[{label:"12 Seats",value:12},{label:"14 Seats",value:14},{label:"16 Seats",value:16},{label:"18 Seats",value:18}],Car:[{label:"4 Seats",value:4},{label:"7 Seats",value:7},{label:"8 Seats",value:8}]};function u(p){var I;const m=document.getElementById("vehicle-seat-options"),g=document.getElementById("vehicle-capacity");if(!m||!g)return;const f=p||((I=document.getElementById("vehicle-type"))==null?void 0:I.value)||"Bus",v=d[f]||d.Bus,x=Number(g.value)||0;m.innerHTML=v.map(L=>`
      <button type="button" class="seat-option-pill${(L.isAbove?x>49:x===L.value)?" active":""}"
        ...
        ${c(L.label)}
      </button>`).join("")}window.selectVehicleSeatPill=function(p,m){const g=document.getElementById("vehicle-capacity");g&&(g.value=p,u(),j())};function b(){const p=document.getElementById("seat-filter-chips");if(!p)return;const m=l.fleetFilter,g=d[m];if(!g||!g.length){p.innerHTML="",l.seatFilter="All";return}p.innerHTML=`
...
Add ${window.location.origin} to the bucket's CORS policy in the Cloudflare dashboard (R2 → tripnix → Settings → CORS), or upload a smaller file.`)}if(!r.ok)throw new Error(`Direct upload to R2 failed (${r.status}).`);return i.url}function Y(e){return Number.isFinite(e)?e>=1048576?`${(e/1048576).toFixed(1)} MB`:`${Math.max(1,Math.round(e/1024))} KB`:"—"}async function Pe(e,t,a){const n=Array.from(e.target.files||[]);if(!n.length)return;const o=document.getElementById("media-upload-status"),i=r=>{o&&(o.textContent=r)};try{for(let r=0;r<n.length;r++){const s=n[r];i(`Uploading ${r+1} of ${n.length} — ${s.name} (${Y(s.size)})…`);const d=await Ae(s,t);l[a].push(d),R()}i("")}catch(r){i(""),alert("❌ "+r.message)}finally{e.target.value=""}}function wt(e){return Pe(e,"vehicles/images","vehicleFormImages")}function $t(e){return Pe(e,"vehicles/videos","vehicleFormVideos")}function R(){const e=document.getElementById("images-preview-grid"),t=document.getElementById("videos-preview-grid");e&&(e.innerHTML=l.vehicleFormImages.map((a,n)=>`
    ...
    `).join(""))}window.removeFormImage=function(e){l.vehicleFormImages.splice(e,1),R()};window.removeFormVideo=function(e){l.vehicleFormVideos.splice(e,1),R()};async function D(){var e;try{const[t,a]=await Promise.all([fetch(`${h}/vehicles`),fetch(`${h}/bookings`)]);if(!t.ok||!a.ok)throw new Error("API error");const n=await t.json(),o=await a.json();if(l.currentUser&&l.currentUser.role!=="superadmin"){const i=l.currentUser.operatorName.toLowerCase();l.vehicles=n.filter(r=>r.operatorName.toLowerCase()===i),l.bookings=o.filter(r=>r.operatorName&&r.operatorName.toLowerCase()===i)}else l.vehicles=n,l.bookings=o;Rt(),U(),Vt(),await Z(),await J(),((e=l.currentUser)==null?void 0:e.role)==="superadmin"&&await Q()}catch(t){console.error("Load error:",t),alert("Cannot connect to backend (http://localhost:3000). Please start the backend first.")}}async function pe(){var t,a,n;await D();const e=document.getElementById("diary-list");e&&(e.innerHTML='<p class="diary-empty">Loading agency diary…</p>');try{const o=((t=l.currentUser)==null?void 0:t.operatorName)||"",i=await fetch(`${h}/trips/agency-diary?operatorName=${encodeURIComponent(o)}`);if(!i.ok)throw new Error("Could not load agency diary");l.agencyDiaryData=await i.json();const r=((a=l.agencyDiaryData)==null?void 0:a.entries)||[],s=new Set;r.forEach(d=>{if(d.status==="Completed"||!d.departureDate||!d.arrivalDate)return;let u=new Date(`${d.departureDate}T00:00:00`);const b=new Date(`${d.arrivalDate}T00:00:00`);for(;u<=b;)s.add(u.toISOString().slice(0,10)),u.setDate(u.getDate()+1)}),l.diary={entries:r,latestTrip:((n=l.agencyDiaryData)==null?void 0:n.latestTrip)||null,bookedDates:Array.from(s)}}catch(o){l.diary=null,e&&(e.innerHTML=`<p class="diary-empty">❌ ${c(o.message)}</p>`);return}Et()}function Et(){xt(),It(),Bt()}function xt(){var n;const e=document.getElementById("latest-diary-trip-container");if(!e)return;const t=(n=l.diary)==null?void 0:n.latestTrip;if(!t){e.innerHTML=`
    ...
    </div>`}function It(){const e=document.getElementById("diary-list"),t=document.getElementById("diary-summary");if(!e)return;const a=l.diary;if(!a){e.innerHTML="",t&&(t.innerHTML="");return}const n=a.entries.filter(r=>r.status!=="Completed"),o=a.entries.filter(r=>r.kind==="diary"),i=o.reduce((r,s)=>r+Number(s.fare||0),0);if(t&&(t.innerHTML=`
    ...
    <tr>
      ...
      <td>
        <span class="badge-status ${Ct(n.status)}">${c(n.status)}</span>
...
${a||""}`),i();document.getElementById("notice-icon").textContent=e,document.getElementById("notice-title").textContent=t,document.getElementById("notice-lead").textContent=a||"",document.getElementById("notice-lines").innerHTML=n.map(u=>`<div><dt>${c(u.label)}</dt><dd>${u.value}</dd></div>`).join("");const s=document.getElementById("notice-ok");s.textContent=o;const d=()=>{r.classList.add("hidden"),s.removeEventListener("click",d),i()};s.addEventListener("click",d),r.classList.remove("hidden")})}function Ue(){const e=V(B()+1);if(!e)return null;const t=z();return!t||t.status!=="active"?{tier:e,charge:e.price,upgrade:!1}:t.tierId===e.tierId?{tier:e,charge:0,upgrade:!1}:{tier:e,charge:Math.max(0,e.price-(t.price||0)),upgrade:!0}}function C(){var e;return((e=l.plans)==null?void 0:e.billingPeriod)||"month"}function fe(){var e,t;return((t=(e=l.subscription)==null?void 0:e.platform)==null?void 0:t.status)==="active"}function Dt(){l.plans&&(Nt(),At(),Mt(),Pt(),Ft(),Ot())}function Nt(){var f;const e=l.plans.platform,t=(f=l.subscription)==null?void 0:f.platform,a=fe(),n=window.location.origin.includes("3005")?"http://localhost:3000/":window.location.origin+"/";document.getElementById("membership-title").textContent=e.name;const o=e.plans||[],i=o.find(v=>v.id===(t==null?void 0:t.planId)),r=o.reduce((v,x)=>v&&v.price<=x.price?v:x,o[0]),s=i||r;document.getElementById("membership-price").textContent=s?`${y(s.price)} / ${s.period}`:y(e.price);const d=document.querySelector(".membership-price-label");d&&(d.textContent=i?"Your platform plan":"Platform fee from"),document.getElementById("membership-benefits").innerHTML=e.features.map(v=>`<li>${c(v)}</li>`).join("");const u=document.getElementById("membership-badge"),b=document.getElementById("membership-card"),p=document.getElementById("membership-status-line"),m=document.getElementById("membership-managed-note");b.classList.toggle("is-active",a),document.getElementById("membership-start").textContent=k(t==null?void 0:t.startsAt),document.getElementById("membership-expiry").textContent=k(t==null?void 0:t.expiresAt),document.getElementById("membership-remaining").textContent=t&&a?`${t.daysLeft} days`:"—",document.getElementById("membership-paid").textContent=t?y(t.amount):"—",a?(u.className="badge-status confirmed",u.textContent="ACTIVE",p.textContent=`${l.subscription.operatorName} is registered. You can add vehicles and browse other agencies' fleets.`,m.innerHTML=`🔒 Managed on the Tripnix site — renew at <a href="${n}" target="_blank" rel="noopener">${n}</a> before it expires.`):t?(u.className="badge-status cancelled",u.textContent="EXPIRED",p.textContent="Your membership has lapsed, so your fleet is hidden from travellers.",m.innerHTML=`⚠️ Renew on the Tripnix site to go live again: <a href="${n}" target="_blank" rel="noopener">${n}</a>`):(u.className="badge-status pending",u.textContent="NOT REGISTERED",p.textContent=e.tagline,m.innerHTML=`⚠️ Pay the platform fee on the Tripnix site to activate your agency: <a href="${n}" target="_blank" rel="noopener">${n}</a>`);const g=document.getElementById("subscription-badge");g&&(g.style.display=a?"none":"inline-block")}function Mt(){var n;const e=l.plans?document.getElementById("plan-grid"):null;if(!e)return;const t=l.plans.fleetTiers||[];if(!t.length){e.innerHTML='<p class="plan-empty">No fleet plan configured.</p>';return}const a=(n=V(B()))==null?void 0:n.id;e.innerHTML=`
    ...
    </div>`}function At(){var n,o,i,r;const e=document.getElementById("platform-plan-options");if(!e)return;const t=((o=(n=l.plans)==null?void 0:n.platform)==null?void 0:o.plans)||[];if(!t.length){e.innerHTML="";return}const a=(r=(i=l.subscription)==null?void 0:i.platform)==null?void 0:r.planId;e.innerHTML=t.map(s=>`
...
Share these credentials with the travel owner.`)}catch(i){alert("❌ "+i.message)}}function jt(){const e=document.getElementById("admins-table-tbody");if(e){if(!l.admins.length){e.innerHTML='<tr><td colspan="7" style="text-align:center;color:var(--text-muted);padding:24px;">No travel owner accounts yet.</td></tr>';return}e.innerHTML=l.admins.map(t=>`
    ...
    <div class="vehicle-admin-card${a.onHold?" is-held":""}">
    ...
    </div>`}).join("")}function Vt(){const e=document.getElementById("all-bookings-tbody"),t=[...l.bookings].reverse();e.innerHTML=t.length?t.map(a=>`
      <tr>
        <td>#${a.id}</td>
      ...
      </tr>`).join(""):'<tr><td colspan="7" style="text-align:center;color:var(--text-muted);padding:32px;">No bookings found.</td></tr>'}let w=null;function zt(){const e=document.getElementById("vehicle-dates");e&&typeof flatpickr<"u"&&!w&&(w=flatpickr(e,{mode:"multiple",dateFormat:"Y-m-d",conjunction:", ",theme:"dark",monthSelectorType:"dropdown",onChange:t=>{X(t)}}),Yt())}function X(e){const t=document.getElementById("selected-date-chips"),a=document.getElementById("selected-dates-count");if(!t)return;const n=(e||[]).map(o=>{if(o instanceof Date){const i=o.getFullYear(),r=String(o.getMonth()+1).padStart(2,"0"),s=String(o.getDate()).padStart(2,"0");return`${i}-${r}-${s}`}return String(o).trim()}).filter(Boolean).sort();if(a&&(a.textContent=`${n.length} date${n.length===1?"":"s"} selected`),n.length===0){t.innerHTML='<span class="no-dates-text">No dates selected yet. Click input or presets above to select dates.</span>';return}t.innerHTML=n.map(o=>`
