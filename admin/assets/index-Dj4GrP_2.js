(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=a(o);fetch(o.href,i)}})();const be="tripnix-fleet-map-styles";function K(e){return e?String(e.place||e.placeName||e.label||"").trim():""}function ce(e){if(!e)return"";const t=String(e.fromPlace||"").trim(),a=String(e.toPlace||"").trim();return!t&&!a?"":t?a?`${t} → ${a}`:`From ${t}`:`To ${a}`}let F=null;function xe(){var e;return(e=window.L)!=null&&e.map?Promise.resolve(window.L):F||(F=new Promise((t,a)=>{if(!document.getElementById("leaflet-css")){const o=document.createElement("link");o.id="leaflet-css",o.rel="stylesheet",o.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",document.head.appendChild(o)}const n=document.createElement("script");n.src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js",n.async=!0,n.onload=()=>{var o;return(o=window.L)!=null&&o.map?t(window.L):a(new Error("Leaflet loaded but unavailable"))},n.onerror=()=>a(new Error("Could not load the map library")),document.head.appendChild(n)}).catch(t=>{throw F=null,t}),F)}function ae(e,t,a,n){var o;return e.divIcon({className:"fmap-pin-wrap",iconSize:[40,54],iconAnchor:[20,20],popupAnchor:[0,-20],html:`
      <div class="fmap-pin${n?" is-sample":""}">
        <img src="${oe(a,(o=t.location)==null?void 0:o.heading)}" alt="" width="38" height="38">
        <span>${C(t.subtitle||t.name)}</span>
      </div>`})}async function ee(e,t,a,{noteEl:n,compact:o,sample:i}){let r;try{r=await xe()}catch(p){return console.warn("[fleet-map]",p.message),!1}let s=A.get(e);if(!s||!e.querySelector(".fmap-canvas")){e.innerHTML=`
      <div class="fmap fmap-live${o?" is-compact":""}">
        <div class="fmap-canvas"></div>
      </div>
      <div class="fmap-legend"></div>`;const p=r.map(e.querySelector(".fmap-canvas"),{zoomControl:!0,attributionControl:!0,scrollWheelZoom:!1});p.attributionControl.setPrefix(!1),p.on("click",()=>p.scrollWheelZoom.enable()),p.on("mouseout",()=>p.scrollWheelZoom.disable()),r.tileLayer("https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png",{maxZoom:19,attribution:"&copy; OpenStreetMap &copy; CARTO"}).addTo(p),s={map:p,markers:new Map,L:r},A.set(e,s)}const d=new Set,u=[];for(const p of a){const m=p.location,f=m.live?"#0ca30c":"#fab219";d.add(p.id),u.push([m.lat,m.lng]);const g=K(m),b=ce(m),k=`
      <strong>${C(p.name)}</strong><br>
      ${C(p.subtitle||"")} · ${m.live?"Live now":m.ageMinutes+" min ago"}<br>
      <small>${g?C(g):"Place name not available"}</small>
      ${m.driverName?"<br><small>Driver: "+C(m.driverName)+"</small>":""}
      ${b?"<br><small>"+C(b)+"</small>":""}
      ${m.speedKph?"<br>"+Math.round(m.speedKph)+" km/h":""}
      ${i?"<br><em>Sample position</em>":""}`;let w=s.markers.get(p.id);w?(w.setLatLng([m.lat,m.lng]),w.setIcon(ae(s.L,p,f,i)),w.setPopupContent(k)):(w=s.L.marker([m.lat,m.lng],{icon:ae(s.L,p,f,i)}).addTo(s.map).bindPopup(k),s.markers.set(p.id,w))}for(const[p,m]of s.markers)d.has(p)||(m.remove(),s.markers.delete(p));!s.framed&&u.length&&(u.length===1?s.map.setView(u[0],12):s.map.fitBounds(u,{padding:o?[30,30]:[55,55]}),s.framed=!0),setTimeout(()=>s.map.invalidateSize(),60);const v=t.total-a.length;return e.querySelector(".fmap-legend").innerHTML=i?`<span><i style="background:#fab219"></i>Sample data</span>
       ...
       ${v?`<span><i style="background:#94a3b8"></i>${v} not reporting</span>`:""}
       <span class="fmap-note">Tap a bus for its detail</span>`,n&&(n.textContent=i?`Sample positions · ${a.length} bus${a.length===1?"":"es"} shown`:`${t.reporting} of ${t.total} reporting`),!0}function ze(e){const t=(e==null?void 0:e.vehicles)||[];return t.filter(n=>n.location).length?{vehicles:t,sample:!1}:t.length?{vehicles:Ie(t),sample:!0}:{vehicles:t,sample:!1}}async function qe(e,t,{sample:a=!1}={}){if(!e)return!1;Be();const n=t==null?void 0:t.location;if(!n)return e.innerHTML='<div class="fmap-mini is-empty"><span>No position yet</span></div>',!1;let o;try{o=await xe()}catch{return e.innerHTML='<div class="fmap-mini is-empty"><span>Map unavailable</span></div>',!1}const i=A.get(e);if(i)return i.marker.setLatLng([n.lat,n.lng]),i.map.setView([n.lat,n.lng],i.map.getZoom()),setTimeout(()=>i.map.invalidateSize(),50),!0;e.innerHTML='<div class="fmap-mini"><div class="fmap-mini-canvas"></div></div>';const r=o.map(e.querySelector(".fmap-mini-canvas"),{zoomControl:!1,attributionControl:!1,dragging:!1,scrollWheelZoom:!1,doubleClickZoom:!1,boxZoom:!1,keyboard:!1,touchZoom:!1}).setView([n.lat,n.lng],11);o.tileLayer("https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png",{maxZoom:19}).addTo(r);const s=o.marker([n.lat,n.lng],{icon:ae(o,t,n.live?"#0ca30c":"#fab219",a),interactive:!1}).addTo(r);return A.set(e,{map:r,marker:s}),setTimeout(()=>r.invalidateSize(),50),!0}let O=null;function Ye(e){var t;return(t=window.google)!=null&&t.maps?Promise.resolve(window.google.maps):O||(O=new Promise((a,n)=>{const o=document.createElement("script");o.src=`https://maps.googleapis.com/maps/api/js?key=${encodeURIComponent(e)}&loading=async&v=weekly`,o.async=!0,o.onload=()=>{var i;return(i=window.google)!=null&&i.maps?a(window.google.maps):n(new Error("Maps API loaded but unavailable"))},o.onerror=()=>n(new Error("Could not load Google Maps — check the API key and its referrer restrictions")),document.head.appendChild(o)}).catch(a=>{throw O=null,a}),O)}function oe(e,t=0){const n=`
    ...
    </svg>`;return"data:image/svg+xml;charset=UTF-8,"+encodeURIComponent(n.trim())}const A=new WeakMap,We={lat:9.9312,lng:76.2673,zoom:9},we=[{label:"Kochi",lat:9.9312,lng:76.2673},{label:"Munnar",lat:10.0889,lng:77.0595},{label:"Thrissur",lat:10.5276,lng:76.2144},{label:"Alappuzha",lat:9.4981,lng:76.3388},{label:"Kottayam",lat:9.5916,lng:76.5222},{label:"Palakkad",lat:10.7867,lng:76.6548},{label:"Kozhikode",lat:11.2588,lng:75.7804},{label:"Thekkady",lat:9.5939,lng:77.16},{label:"Kollam",lat:8.8932,lng:76.6141},{label:"Wayanad",lat:11.6854,lng:76.132}];function Ge(e){const t=String(e??"");let a=0;for(let n=0;n<t.length;n++)a=a*31+t.charCodeAt(n)|0;return Math.abs(a)}function Ie(e){return e.map((t,a)=>{const n=we[(Ge(t.id)+a)%we.length];return{...t,location:{lat:n.lat,lng:n.lng,place:n.label,placeName:n.label,label:n.label,live:a%3!==2,ageMinutes:a%3===2?40+a*7:0,speedKph:a%3===2?0:30+a*9,sample:!0}}})}function Be(){if(document.getElementById(be))return;const e=document.createElement("style");e.id=be,e.textContent=`
  ...
  `,document.head.appendChild(e)}function C(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ke(e,t,{noteEl:a,compact:n}){const{lat:o,lng:i,zoom:r}=We,s=`https://www.google.com/maps?q=${o},${i}&hl=en&z=${r}&output=embed`;a&&(a.textContent=t.total?"No bus has reported a position yet":""),e.innerHTML=`
    ...
    </div>`}function q(e,t,a,{noteEl:n,compact:o,sample:i=!1}){const r=e.dataset.fleetMapBus,s=a.find(m=>String(m.id)===r)||a.find(m=>m.location.live)||a[0];e.dataset.fleetMapBus=String(s.id);const d=s.location,u=`https://www.google.com/maps?q=${d.lat},${d.lng}&hl=en&z=${o?13:14}&output=embed`,v=a.map(m=>{const f=m.id===s.id,g=m.location.live;return`
      <button type="button" class="fmap-chip${f?" is-on":""}"
              data-fleet-map-bus="${m.id}">
        <i style="background:${g?"#0ca30c":"#fab219"}"></i>
        ${C(m.subtitle||m.name)}
        <span>${g?"live":m.location.ageMinutes+"m"}</span>
      </button>`}).join(""),p=t.total-a.length;if(e.innerHTML=`
    ${a.length>1?`<div class="fmap-chips">${v}</div>`:""}
    <div class="fmap fmap-live${o?" is-compact":""}">
    ...
    <div class="fmap-legend">
      ...
      <a class="fmap-open" target="_blank" rel="noopener"
        ...
        Open in Google Maps ↗</a>
    </div>`,e.querySelectorAll("[data-fleet-map-bus]").forEach(m=>m.addEventListener("click",()=>{e.dataset.fleetMapBus=m.dataset.fleetMapBus,q(e,t,a,{noteEl:n,compact:o,sample:i})})),n){const m=K(d);n.textContent=i?`Sample positions · showing ${s.subtitle||s.name}${m?" near "+m:""}`:`${t.reporting} of ${t.total} reporting · showing ${s.subtitle||s.name}${m?" near "+m:""}`}}async function _e(e,t,a,{noteEl:n,compact:o,apiKey:i}){let r;try{r=await Ye(i)}catch(f){return console.warn("[fleet-map]",f.message),!1}let s=A.get(e);if(!s){e.innerHTML=`<div class="fmap fmap-live${o?" is-compact":""}"><div class="fmap-canvas"></div></div>`;const f=e.querySelector(".fmap-canvas");s={map:new r.Map(f,{center:{lat:a[0].location.lat,lng:a[0].location.lng},zoom:12,mapTypeControl:!o,streetViewControl:!1,fullscreenControl:!o,zoomControl:!0,backgroundColor:"#eef1f5",gestureHandling:"cooperative"}),markers:new Map,info:new r.InfoWindow},A.set(e,s)}const d=new Set,u=new r.LatLngBounds;for(const f of a){const g=f.location,b=g.live?"#0ca30c":"#fab219",k={lat:g.lat,lng:g.lng};u.extend(k),d.add(f.id);const w=f.subtitle||f.name,L=K(g),S=`${g.live?"Live now":g.ageMinutes+" min ago"}${L?" · "+C(L):""}${g.speedKph?" · "+Math.round(g.speedKph)+" km/h":""}`;let E=s.markers.get(f.id);E?(E.setPosition(k),E.setIcon({url:oe(b,g.heading),scaledSize:new r.Size(38,38),anchor:new r.Point(19,19)})):(E=new r.Marker({map:s.map,position:k,title:`${f.name} · ${S.replace(/<[^>]*>/g,"")}`,icon:{url:oe(b,g.heading),scaledSize:new r.Size(38,38),anchor:new r.Point(19,19)},zIndex:g.live?2:1}),s.markers.set(f.id,E)),E.addListener("click",()=>{const N=ce(g);s.info.setContent(`<div style="font-family:system-ui;color:#0b1220;min-width:150px">
           <strong style="font-size:13px">${C(f.name)}</strong><br>
           <span style="font-size:11px;color:#475569">${C(w)} · ${S}</span><br>
         ...
         </div>`),s.info.open({map:s.map,anchor:E})})}for(const[f,g]of s.markers)d.has(f)||(g.setMap(null),s.markers.delete(f));s.framed||(a.length===1?(s.map.setCenter(u.getCenter()),s.map.setZoom(13)):s.map.fitBounds(u,o?24:48),s.framed=!0),n&&(n.textContent=`${t.reporting} of ${t.total} reporting · live map`);const v=t.total-a.length,p=e.querySelector(".fmap-legend"),m=`
    <span><i style="background:#0ca30c"></i>Live</span>
    <span><i style="background:#fab219"></i>Last seen earlier</span>
    ${v?`<span><i style="background:#94a3b8"></i>${v} not reporting</span>`:""}
    <span class="fmap-note">Tap a bus for its detail</span>`;return p?p.innerHTML=m:e.insertAdjacentHTML("beforeend",`<div class="fmap-legend">${m}</div>`),!0}function Je(e,t,{noteEl:a=null,compact:n=!1,apiKey:o=""}={}){if(!e)return;Be();const i=((t==null?void 0:t.vehicles)||[]).filter(r=>r.location);if(!i.length){A.delete(e);const r=(t==null?void 0:t.vehicles)||[];if(!r.length){delete e.dataset.fleetMapBus,Ke(e,t,{noteEl:a,compact:n});return}const s=Ie(r),d={...t,reporting:0,total:r.length};ee(e,d,s,{noteEl:a,compact:n,sample:!0}).then(u=>{u||q(e,d,s,{noteEl:a,compact:n,sample:!0})});return}if(o){_e(e,t,i,{noteEl:a,compact:n,apiKey:o}).then(r=>{if(!r)return ee(e,t,i,{noteEl:a,compact:n,sample:!1}).then(s=>{s||q(e,t,i,{noteEl:a,compact:n})})});return}ee(e,t,i,{noteEl:a,compact:n,sample:!1}).then(r=>{r||q(e,t,i,{noteEl:a,compact:n})})}const h=window.location.origin.includes("3005")?"http://localhost:3000/api":window.location.origin+"/api";let l={currentUser:JSON.parse(sessionStorage.getItem("tripnix_user")||"null"),vehicles:[],bookings:[],admins:[],plans:null,subscription:null,accounts:null,accountCategories:null,tracking:null,agencySubs:[],trips:[],activeTab:"dashboard",fleetFilter:"All",searchQuery:"",editingVehicleId:null,vehicleFormImages:[],vehicleFormVideos:[],diaryVehicleId:null,diary:null};const ke=document.getElementById("login-screen"),Le=document.getElementById("app-layout"),Ce=document.getElementById("login-form"),te=document.getElementById("login-error"),Ze=document.getElementById("logout-btn"),Te=document.querySelectorAll(".nav-item"),Qe=document.querySelectorAll(".tab-page"),$e=document.getElementById("nav-admins"),Xe=document.getElementById("page-title"),et=document.getElementById("page-subtitle"),Ee=document.getElementById("pending-badge"),tt=document.getElementById("refresh-btn"),re=document.getElementById("add-vehicle-header-btn"),Se=document.getElementById("vehicle-modal"),nt=document.getElementById("modal-title"),at=document.getElementById("modal-close-btn"),ot=document.getElementById("modal-cancel-btn"),De=document.getElementById("vehicle-form"),ie=document.getElementById("create-admin-form");document.addEventListener("DOMContentLoaded",()=>{pt(),wt(),rt(),it()});function rt(){const e=document.getElementById("register-link");e&&(e.href=window.location.origin.includes("3005")?"http://localhost:3000/":window.location.origin+"/")}function it(){l.currentUser?Me():Ne()}function Ne(){ke.classList.remove("hidden"),Le.classList.add("hidden")}function Me(){ke.classList.add("hidden"),Le.classList.remove("hidden"),st(),D()}function st(){const e=l.currentUser;if(!e)return;const t=e.operatorName||"Travel Agency",a=e.username||"admin",n=t.charAt(0).toUpperCase(),o=document.getElementById("agency-identity-block");o&&o.classList.remove("hidden"),document.getElementById("agency-avatar-letter").textContent=n,document.getElementById("agency-name-display").textContent=t,document.getElementById("agency-username-display").textContent="@"+a;const i=document.getElementById("profile-logout-row");i&&i.classList.remove("hidden"),document.getElementById("profile-mini-avatar").textContent=n,document.getElementById("profile-mini-name").textContent=t,document.getElementById("profile-mini-username").textContent="@"+a;const r=document.getElementById("hero-agency-name");r&&(r.textContent=t),e.role==="superadmin"?$e.classList.remove("hidden"):($e.classList.add("hidden"),l.activeTab==="admins"&&me("dashboard"))}async function lt(e){e.preventDefault(),te.classList.add("hidden");const t=document.getElementById("login-username").value.trim(),a=document.getElementById("login-password").value.trim(),n=document.getElementById("login-submit-btn");n.textContent="Signing in…",n.disabled=!0;try{const o=await fetch(`${h}/auth/login`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:t,password:a})});let i=null;try{i=await o.json()}catch{i=null}if(!o.ok)throw new Error((i==null?void 0:i.error)||"Invalid username or password");if(!i)throw new Error("Invalid response from backend server");l.currentUser=i,sessionStorage.setItem("tripnix_user",JSON.stringify(i)),Ce.reset(),Me()}catch(o){te.textContent="⚠️ "+o.message,te.classList.remove("hidden")}finally{n.textContent="Sign In",n.disabled=!1}}function dt(){pe(),l.currentUser=null,l.vehicles=[],l.bookings=[],l.admins=[],l.tracking=null,sessionStorage.removeItem("tripnix_user");const e=document.getElementById("agency-identity-block"),t=document.getElementById("profile-logout-row");e&&e.classList.add("hidden"),t&&t.classList.add("hidden"),document.getElementById("agency-avatar-letter").textContent="",document.getElementById("agency-name-display").textContent="",document.getElementById("agency-username-display").textContent="",document.getElementById("profile-mini-avatar").textContent="",document.getElementById("profile-mini-name").textContent="",document.getElementById("profile-mini-username").textContent="",Ne()}function ct(){const e=document.getElementById("sidebar"),t=document.getElementById("sidebar-overlay");if(!e||!t)return;e.classList.contains("active")?W():mt()}function mt(){const e=document.getElementById("sidebar"),t=document.getElementById("sidebar-overlay");e&&e.classList.add("active"),t&&t.classList.add("active")}function W(){const e=document.getElementById("sidebar"),t=document.getElementById("sidebar-overlay");e&&e.classList.remove("active"),t&&t.classList.remove("active")}function pt(){Te.forEach(e=>{e.addEventListener("click",()=>{me(e.getAttribute("data-tab"))})})}function me(e){l.activeTab=e,W(),Te.forEach(a=>{a.classList.toggle("active",a.getAttribute("data-tab")===e)}),Qe.forEach(a=>{a.classList.toggle("active",a.id===`tab-${e}`)});const t={dashboard:["Dashboard Overview","Real-time bus schedules and fleet operations"],fleet:["Fleet Management","Add buses, edit details, and post available dates"],bookings:["Customer Bookings","Review and manage booking requests"],trips:["Trips","Post trips that appear in the traveller app story bar"],schedule:["Bus Diary","The running schedule for each bus in your fleet"],accounts:["Accounts","What the diary earned, against what you have paid Tripnix"],gps:["Location","Where every bus last reported from"],subscription:["Subscription & Plans","Platform membership and the fleet plan"],admins:["Manage Travel Owners","Create and manage Travel Owner login credentials"]};t[e]&&(Xe.textContent=t[e][0],et.textContent=t[e][1]),e==="admins"&&Q(),e==="subscription"&&Z(),e==="trips"&&J(),e==="schedule"&&ue(),e==="accounts"&&_(),e==="gps"?vt():pe()}async function _(e){var a;const t=(a=l.currentUser)==null?void 0:a.operatorName;if(t)try{const n=e?`&month=${encodeURIComponent(e)}`:"",o=await fetch(`${h}/accounts?operatorName=${encodeURIComponent(t)}${n}`);if(!o.ok)throw new Error("Could not load accounts");if(l.accounts=await o.json(),!l.accountCategories){const i=await fetch(`${h}/accounts/categories`);i.ok&&(l.accountCategories=await i.json())}yt()}catch(n){document.getElementById("acc-breakdown").innerHTML=`<p class="diary-empty">❌ ${c(n.message)}</p>`}}async function ut(){var e;if(!l.vehicles.length)return alert("❌ Add a bus to your fleet first.");if(!l.accountCategories)try{const t=await fetch(`${h}/accounts/categories`);t.ok&&(l.accountCategories=await t.json())}catch{}document.getElementById("acc-entry-date").value=new Date().toISOString().slice(0,10),document.getElementById("acc-entry-amount").value="",document.getElementById("acc-entry-note").value="",Ae(((e=document.querySelector('input[name="acc-kind"]:checked'))==null?void 0:e.value)||"income"),document.getElementById("acc-entry-modal").classList.remove("hidden"),document.getElementById("acc-entry-amount").focus()}function se(){document.getElementById("acc-entry-modal").classList.add("hidden"),document.getElementById("acc-entry-form").reset()}function gt(e,t){return Array.isArray(t)&&t.length?t.map(a=>`<optgroup label="${c(a.group)}">`+(a.items||[]).map(n=>`<option>${c(n)}</option>`).join("")+"</optgroup>").join(""):(e||[]).map(a=>`<option>${c(a)}</option>`).join("")}function Ae(e){var a,n,o,i;document.getElementById("acc-entry-category").innerHTML=gt((n=(a=l.accountCategories)==null?void 0:a.categories)==null?void 0:n[e],(i=(o=l.accountCategories)==null?void 0:o.groups)==null?void 0:i[e]);const t=l.vehicles.map(r=>`<option value="${r.id}">${c(r.name)} · ${c(r.vehicleNumber||"—")}</option>`);document.getElementById("acc-entry-vehicle").innerHTML=e==="capital"?t.join(""):'<option value="">Whole agency</option>'+t.join(""),document.getElementById("acc-entry-vehicle-req").textContent=e==="capital"?"*":"",document.getElementById("acc-entry-hint").textContent=e==="capital"?"What the bus cost to buy. Recorded once, not as a monthly expense — it is the sum the bus has to earn back.":e==="income"?"Money in that is not already a diary order — a private contract, a rental, anything else.":"Money out — running the bus, staff, office rent, compliance, finance. Leave the bus blank for costs that cover the whole agency."}async function ft(e){e.preventDefault();const t=document.getElementById("acc-entry-save"),a=t.textContent;t.disabled=!0,t.textContent="Saving…";try{const n=await fetch(`${h}/accounts/entries`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({operatorName:l.currentUser.operatorName,kind:document.querySelector('input[name="acc-kind"]:checked').value,vehicleId:document.getElementById("acc-entry-vehicle").value||null,amount:document.getElementById("acc-entry-amount").value,date:document.getElementById("acc-entry-date").value,category:document.getElementById("acc-entry-category").value,note:document.getElementById("acc-entry-note").value.trim()})}),o=await n.json().catch(()=>null);if(!n.ok)throw new Error((o==null?void 0:o.error)||"Could not save this entry");se(),await _(String(o.date).slice(0,7))}catch(n){alert("❌ "+n.message)}finally{t.disabled=!1,t.textContent=a}}window.removeAccEntry=async function(e){var t;if(confirm("Remove this entry from the books?"))try{if(!(await fetch(`${h}/accounts/entries/${e}?operatorName=${encodeURIComponent(l.currentUser.operatorName)}`,{method:"DELETE"})).ok)throw new Error("Could not remove this entry");await _((t=l.accounts)==null?void 0:t.month)}catch(a){alert("❌ "+a.message)}};function yt(){const e=l.accounts;if(!e)return;const t=document.getElementById("acc-month");t&&document.activeElement!==t&&(t.innerHTML=e.availableMonths.length?e.availableMonths.map(n=>`<option value="${n.value}" ${n.value===e.month?"selected":""}>${c(n.label)}</option>`).join(""):`<option>${c(e.monthLabel)}</option>`),document.getElementById("acc-stats").innerHTML=`
    ...
    <p class="panel-header-note" style="margin-top:10px;line-height:1.6;">
      ...
      the owner in the Owner Portal.
        ...
        </div>`).join(""):'<p class="diary-empty">Nothing recorded for this month yet. Use ➕ Add entry to record fuel, wages, servicing or extra income.</p>'}const ht=2e4;let H=null;function vt(){pe(),le(),H=setInterval(()=>{document.hidden||le()},ht)}function pe(){H&&clearInterval(H),H=null}document.addEventListener("visibilitychange",()=>{!document.hidden&&H&&le()});async function le(){var t;const e=(t=l.currentUser)==null?void 0:t.operatorName;if(e)try{if(l.mapsApiKey===void 0){const n=await fetch(`${h}/tracking/config`).catch(()=>null),o=n!=null&&n.ok?await n.json():null;l.mapsApiKey=(o==null?void 0:o.mapsApiKey)||""}const a=await fetch(`${h}/tracking?operatorName=${encodeURIComponent(e)}`);if(!a.ok)throw new Error("Could not load tracking");l.tracking=await a.json(),bt()}catch(a){if(l.tracking)return;document.getElementById("gps-list").innerHTML=`<p class="diary-empty">❌ ${c(a.message)}</p>`}}function bt(){const e=l.tracking;if(!e)return;const{vehicles:t,sample:a}=ze(e);Je(document.getElementById("gps-map"),e,{noteEl:document.getElementById("gps-map-note"),apiKey:l.mapsApiKey}),document.getElementById("gps-note").textContent=a?`Sample positions · live for ${e.staleAfterMinutes} minutes after the last fix`:`${e.reporting} of ${e.total} reporting · live for ${e.staleAfterMinutes} minutes after the last fix`,document.getElementById("gps-list").innerHTML=t.length?t.map(n=>{const o=n.location,i=a?'<span class="badge-status cancelled">SAMPLE</span>':o?o.live?'<span class="badge-status confirmed">LIVE</span>':`<span class="badge-status cancelled">${o.ageMinutes} MIN AGO</span>`:'<span class="badge-status pending">NO SIGNAL</span>',r=K(o),s=o?`${r?c(r):"Position received, place name not available"}${o.speedKph?" · "+Math.round(o.speedKph)+" km/h":""}`:"This bus has never reported a position",d=ce(o),u=[o!=null&&o.driverName?"Driver: "+c(o.driverName):"",d?c(d):""].filter(Boolean).join(" · "),v=u?`<div class="diary-row-who">${u}</div>`:"",p=o?` · <a href="https://www.google.com/maps?q=${o.lat},${o.lng}" target="_blank" rel="noopener">Open map ↗</a>`:"";return`
          <div class="diary-row gps-row">
            <div class="diary-row-main">
              <strong>${c(n.name)}</strong>
              <code class="vehicle-number">${c(n.subtitle||"—")}</code>
              <div class="diary-row-who">${s}${p}</div>
              ${v}
              <div class="diary-row-status">${i}</div>
            </div>
            <div class="row-map" data-bus-map="${n.id}"></div>
          </div>`}).join(""):'<p class="diary-empty">No buses in the fleet yet.</p>';for(const n of t)qe(document.querySelector(`[data-bus-map="${n.id}"]`),n,{sample:a})}function wt(){var e,t,a,n,o,i,r,s,d,u,v,p,m,f,g,b,k,w,L,S,E,N,he,ve;Ce.addEventListener("submit",lt),Ze.addEventListener("click",dt),(e=document.getElementById("sidebar-toggle-btn"))==null||e.addEventListener("click",ct),(t=document.getElementById("sidebar-overlay"))==null||t.addEventListener("click",W),(a=document.getElementById("sidebar-close-btn"))==null||a.addEventListener("click",W),tt.addEventListener("click",D),re.addEventListener("click",()=>{if(l.subscription&&!ye()){alert(`🔒 Your agency is not registered yet.

The yearly platform fee is paid on the Tripnix site. See the Subscription page for the link.`),me("subscription");return}Re()}),at.addEventListener("click",G),ot.addEventListener("click",G),(n=document.getElementById("diary-add-btn"))==null||n.addEventListener("click",()=>ge()),(o=document.getElementById("diary-modal-close"))==null||o.addEventListener("click",de),(i=document.getElementById("diary-modal-cancel"))==null||i.addEventListener("click",de),(r=document.getElementById("diary-form"))==null||r.addEventListener("submit",Tt),(s=document.getElementById("acc-month"))==null||s.addEventListener("change",x=>_(x.target.value)),(d=document.getElementById("acc-add-btn"))==null||d.addEventListener("click",ut),(u=document.getElementById("acc-entry-close"))==null||u.addEventListener("click",se),(v=document.getElementById("acc-entry-cancel"))==null||v.addEventListener("click",se),(p=document.getElementById("acc-entry-form"))==null||p.addEventListener("submit",ft),document.querySelectorAll('input[name="acc-kind"]').forEach(x=>x.addEventListener("change",M=>Ae(M.target.value))),(m=document.getElementById("diary-from"))==null||m.addEventListener("change",x=>{const M=document.getElementById("diary-to");M&&(!M.value||M.value<x.target.value)&&(M.value=x.target.value)}),document.querySelectorAll(".filter-chips .chip[data-filter]").forEach(x=>{x.addEventListener("click",()=>{document.querySelectorAll(".filter-chips .chip[data-filter]").forEach(M=>M.classList.remove("active")),x.classList.add("active"),l.fleetFilter=x.getAttribute("data-filter"),l.seatFilter="All",renderFleetSeatFilterChips(),j()})}),document.getElementById("fleet-search").addEventListener("input",x=>{l.searchQuery=x.target.value,j()}),(f=document.getElementById("vehicle-number"))==null||f.addEventListener("input",x=>{x.target.value=x.target.value.toUpperCase()}),De.addEventListener("submit",_t),(g=document.getElementById("upload-images-btn"))==null||g.addEventListener("click",()=>{var x;(x=document.getElementById("vehicle-images-input"))==null||x.click()}),(b=document.getElementById("upload-videos-btn"))==null||b.addEventListener("click",()=>{var x;(x=document.getElementById("vehicle-videos-input"))==null||x.click()}),(k=document.getElementById("vehicle-images-input"))==null||k.addEventListener("change",xt),(w=document.getElementById("vehicle-videos-input"))==null||w.addEventListener("change",It),(L=document.getElementById("vehicle-type"))==null||L.addEventListener("change",U),(S=document.getElementById("vehicle-capacity"))==null||S.addEventListener("input",U),ie&&ie.addEventListener("submit",Vt),(E=document.getElementById("pricing-form"))==null||E.addEventListener("submit",Rt),(N=document.getElementById("trip-form"))==null||N.addEventListener("submit",Mt),(he=document.getElementById("trip-image-btn"))==null||he.addEventListener("click",()=>{var x;(x=document.getElementById("trip-image-input"))==null||x.click()}),(ve=document.getElementById("trip-image-input"))==null||ve.addEventListener("change",St),$t()}function $t(){const e=document.getElementById("vehicle-type-dropdown"),t=document.getElementById("vehicle-type-trigger"),a=document.getElementById("vehicle-type-menu"),n=document.getElementById("vehicle-type"),o=document.getElementById("selected-type-icon"),i=document.getElementById("selected-type-text"),r=a==null?void 0:a.querySelectorAll(".custom-dropdown-item");if(!t||!a||!n)return;const s={Bus:"🚌",Traveller:"🚐",Car:"🚗"},d={Bus:[{label:"12 Seats",value:12},{label:"22 Seats",value:22},{label:"36 Seats",value:36},{label:"49 Seats",value:49},{label:"Above 49 Seats",value:50,isAbove:!0}],Traveller:[{label:"12 Seats",value:12},{label:"14 Seats",value:14},{label:"16 Seats",value:16},{label:"18 Seats",value:18}],Car:[{label:"4 Seats",value:4},{label:"7 Seats",value:7},{label:"8 Seats",value:8}]};function u(p){var w;const m=document.getElementById("vehicle-seat-options"),f=document.getElementById("vehicle-capacity");if(!m||!f)return;const g=p||((w=document.getElementById("vehicle-type"))==null?void 0:w.value)||"Bus",b=d[g]||d.Bus,k=Number(f.value)||0;m.innerHTML=b.map(L=>`
      <button type="button" class="seat-option-pill${(L.isAbove?k>49:k===L.value)?" active":""}"
        ...
        ${c(L.label)}
      </button>`).join("")}window.selectVehicleSeatPill=function(p,m){const f=document.getElementById("vehicle-capacity");f&&(f.value=p,u(),U())};function v(){const p=document.getElementById("seat-filter-chips");if(!p)return;const m=l.fleetFilter,f=d[m];if(!f||!f.length){p.innerHTML="",l.seatFilter="All";return}p.innerHTML=`
...
Add ${window.location.origin} to the bucket's CORS policy in the Cloudflare dashboard (R2 → tripnix → Settings → CORS), or upload a smaller file.`)}if(!r.ok)throw new Error(`Direct upload to R2 failed (${r.status}).`);return i.url}function Y(e){return Number.isFinite(e)?e>=1048576?`${(e/1048576).toFixed(1)} MB`:`${Math.max(1,Math.round(e/1024))} KB`:"—"}async function Fe(e,t,a){const n=Array.from(e.target.files||[]);if(!n.length)return;const o=document.getElementById("media-upload-status"),i=r=>{o&&(o.textContent=r)};try{for(let r=0;r<n.length;r++){const s=n[r];i(`Uploading ${r+1} of ${n.length} — ${s.name} (${Y(s.size)})…`);const d=await Pe(s,t);l[a].push(d),R()}i("")}catch(r){i(""),alert("❌ "+r.message)}finally{e.target.value=""}}function xt(e){return Fe(e,"vehicles/images","vehicleFormImages")}function It(e){return Fe(e,"vehicles/videos","vehicleFormVideos")}function R(){const e=document.getElementById("images-preview-grid"),t=document.getElementById("videos-preview-grid");e&&(e.innerHTML=l.vehicleFormImages.map((a,n)=>`
    ...
    `).join(""))}window.removeFormImage=function(e){l.vehicleFormImages.splice(e,1),R()};window.removeFormVideo=function(e){l.vehicleFormVideos.splice(e,1),R()};async function D(){var e;try{const[t,a]=await Promise.all([fetch(`${h}/vehicles`),fetch(`${h}/bookings`)]);if(!t.ok||!a.ok)throw new Error("API error");const n=await t.json(),o=await a.json();if(l.currentUser&&l.currentUser.role!=="superadmin"){const i=l.currentUser.operatorName.toLowerCase();l.vehicles=n.filter(r=>r.operatorName.toLowerCase()===i),l.bookings=o.filter(r=>r.operatorName&&r.operatorName.toLowerCase()===i)}else l.vehicles=n,l.bookings=o;qt(),j(),Yt(),await Z(),await J(),((e=l.currentUser)==null?void 0:e.role)==="superadmin"&&await Q()}catch(t){console.error("Load error:",t),alert("Cannot connect to backend (http://localhost:3000). Please start the backend first.")}}async function ue(){var t,a,n;await D();const e=document.getElementById("diary-list");e&&(e.innerHTML='<p class="diary-empty">Loading agency diary…</p>');try{const o=((t=l.currentUser)==null?void 0:t.operatorName)||"",i=await fetch(`${h}/trips/agency-diary?operatorName=${encodeURIComponent(o)}`);if(!i.ok)throw new Error("Could not load agency diary");l.agencyDiaryData=await i.json();const r=((a=l.agencyDiaryData)==null?void 0:a.entries)||[],s=new Set;r.forEach(d=>{if(d.status==="Completed"||!d.departureDate||!d.arrivalDate)return;let u=new Date(`${d.departureDate}T00:00:00`);const v=new Date(`${d.arrivalDate}T00:00:00`);for(;u<=v;)s.add(u.toISOString().slice(0,10)),u.setDate(u.getDate()+1)}),l.diary={entries:r,latestTrip:((n=l.agencyDiaryData)==null?void 0:n.latestTrip)||null,bookedDates:Array.from(s)}}catch(o){l.diary=null,e&&(e.innerHTML=`<p class="diary-empty">❌ ${c(o.message)}</p>`);return}Bt()}function Bt(){kt(),Lt(),Ct()}function kt(){var n;const e=document.getElementById("latest-diary-trip-container");if(!e)return;const t=(n=l.diary)==null?void 0:n.latestTrip;if(!t){e.innerHTML=`
    ...
    <div class="latest-diary-card">
    ...
    </div>`}function Lt(){const e=document.getElementById("diary-list"),t=document.getElementById("diary-summary");if(!e)return;const a=l.diary;if(!a){e.innerHTML="",t&&(t.innerHTML="");return}const n=a.entries.filter(r=>r.status!=="Completed"),o=a.entries.filter(r=>r.kind==="diary"),i=o.reduce((r,s)=>r+Number(s.fare||0),0);if(t&&(t.innerHTML=`
      ...
      <div class="diary-stat"><strong>${y(i)}</strong><span>Total Fares</span></div>`),!a.entries.length){e.innerHTML='<p class="diary-empty">No orders in your agency diary yet. Use ➕ Add Entry to write an order, or tap a date on the calendar.</p>';return}e.innerHTML=a.entries.map(r=>{const s=r.status==="On Trip"?"confirmed":r.status==="Completed"?"cancelled":"pending",d=r.kind==="diary",u=r.customerPhone?` · <a href="tel:${c(r.customerPhone)}">${c(r.customerPhone)}</a>`:"";let v="";d||r.kind==="booking"?v=`<div class="diary-row-who">👤 ${c(r.customerName||"Customer")}${u}${r.fare?` · <strong>${y(r.fare)}</strong>`:""}</div>`:r.note&&(v=`<div class="diary-row-who">${c(r.note)}</div>`),d&&r.note&&(v+=`<div class="diary-row-who" style="color:var(--text-muted);">📝 ${c(r.note)}</div>`);const p=d?"📕 "+c(r.place||"Agency Order"):r.kind==="booking"?"📑 Customer booking":"🗺️ "+c(r.place||"Trip"),m=d?`<div class="diary-row-actions">
      ...
      <div class="diary-row">
        <div class="diary-row-dates">
          <strong>${B(r.departureDate)}</strong>
          <span>→ ${B(r.arrivalDate)}</span>
      ...
      </div>`}).join("")}function Ct(){const e=document.getElementById("diary-calendar");if(!e)return;const t=l.diary;if(!t){e.innerHTML="";return}const a=new Set(t.bookedDates),n=new Date,o=[0,1].map(i=>new Date(n.getFullYear(),n.getMonth()+i,1));e.innerHTML=o.map(i=>{const r=i.toLocaleDateString(void 0,{month:"long",year:"numeric"}),s=new Date(i.getFullYear(),i.getMonth()+1,0).getDate(),d=(i.getDay()+6)%7,u=p=>(t.entries||[]).filter(m=>m.status!=="Completed"&&p>=m.departureDate&&p<=m.arrivalDate).map(m=>`${m.customerName||"Booked"}${m.place?" — "+m.place:""}`).join(" | "),v=[];for(let p=0;p<d;p++)v.push('<span class="diary-day is-blank"></span>');for(let p=1;p<=s;p++){const m=`${i.getFullYear()}-${String(i.getMonth()+1).padStart(2,"0")}-${String(p).padStart(2,"0")}`,f=a.has(m),g=f?`${m} — ${u(m)}`:`${m} — free, tap to write an order`;v.push(`<span class="diary-day${f?" is-booked":""}" title="${c(g)}"${f?"":` role="button" onclick="openDiaryModalForDate('${m}')"`}>${p}</span>`)}return`
      <div class="diary-month">
        ...
        <div class="diary-grid">${v.join("")}</div>
      </div>`}).join("")}function ge(e=null,t=null){const a=document.getElementById("diary-modal");if(!a)return;document.getElementById("diary-modal-title").textContent=e?"Edit Diary Entry":"New Diary Entry";const n=document.getElementById("diary-modal-bus");n&&(n.textContent="📕 Agency Travel Order"),document.getElementById("diary-entry-id").value=(e==null?void 0:e.id)??"",document.getElementById("diary-customer").value=(e==null?void 0:e.customerName)??"",document.getElementById("diary-phone").value=(e==null?void 0:e.customerPhone)??"",document.getElementById("diary-place").value=(e==null?void 0:e.place)??"",document.getElementById("diary-from").value=(e==null?void 0:e.departureDate)??t??"",document.getElementById("diary-to").value=(e==null?void 0:e.arrivalDate)??t??"",document.getElementById("diary-fare").value=e!=null&&e.fare?String(e.fare):"",document.getElementById("diary-note").value=(e==null?void 0:e.note)??"",document.getElementById("diary-save-btn").textContent=e?"Update Entry":"Save Entry",a.classList.remove("hidden"),document.getElementById("diary-customer").focus()}function de(){var e,t;(e=document.getElementById("diary-modal"))==null||e.classList.add("hidden"),(t=document.getElementById("diary-form"))==null||t.reset()}window.openDiaryModalForDate=function(e){ge(null,e)};window.editDiaryEntry=function(e){var a;const t=(((a=l.diary)==null?void 0:a.entries)||[]).find(n=>n.id===e);t&&ge(t)};window.deleteDiaryEntry=async function(e){var a;const t=(((a=l.diary)==null?void 0:a.entries)||[]).find(n=>n.id===e);if(t&&confirm(`Remove ${t.customerName||"this entry"} (${B(t.departureDate)} → ${B(t.arrivalDate)}) from the agency diary?`))try{if(!(await fetch(`${h}/trips/${e}`,{method:"DELETE"})).ok)throw new Error("Could not remove this entry");await ue()}catch(n){alert("❌ "+n.message)}};async function Tt(e){var i;e.preventDefault();const t=document.getElementById("diary-entry-id").value,a={operatorName:(i=l.currentUser)==null?void 0:i.operatorName,customerName:document.getElementById("diary-customer").value.trim(),customerPhone:document.getElementById("diary-phone").value.trim(),place:document.getElementById("diary-place").value.trim(),departureDate:document.getElementById("diary-from").value,arrivalDate:document.getElementById("diary-to").value,fare:document.getElementById("diary-fare").value,note:document.getElementById("diary-note").value.trim()},n=document.getElementById("diary-save-btn"),o=n.textContent;n.disabled=!0,n.textContent="Saving…";try{const r=await fetch(t?`${h}/trips/diary/${t}`:`${h}/trips/diary`,{method:t?"PUT":"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)}),s=await r.json().catch(()=>null);if(!r.ok)throw new Error((s==null?void 0:s.error)||"Could not save this entry");de(),await ue()}catch(r){alert("❌ "+r.message)}finally{n.disabled=!1,n.textContent=o}}async function J(){var t;const e=(t=l.currentUser)==null?void 0:t.operatorName;if(e)try{const a=l.currentUser.role==="superadmin"?`${h}/trips`:`${h}/trips?operatorName=${encodeURIComponent(e)}`,n=await fetch(a);if(!n.ok)throw new Error("Failed to load trips");l.trips=await n.json(),Oe(),Nt()}catch(a){console.error("Trips load error:",a)}}function Oe(){const e=document.getElementById("trip-vehicle");if(!e)return;if(!l.vehicles.length){e.innerHTML='<option value="">No vehicles in your fleet yet</option>';return}const t=fe(),a=e.value;e.innerHTML=l.vehicles.map(n=>`
    <option value="${n.id}" ${t?"":"disabled"}>
      ${c(n.name)} · ${c(n.vehicleNumber||"—")}${t?"":"  (fleet fee not paid)"}
    </option>`).join(""),a&&(e.value=a)}async function St(e){const t=(e.target.files||[])[0];if(!t)return;const a=document.getElementById("trip-image-status"),n=a==null?void 0:a.textContent;a&&(a.textContent="Uploading to R2…");try{const o=await Pe(t,"trips");document.getElementById("trip-image").value=o,He(),a&&(a.textContent="Uploaded ✓")}catch(o){a&&(a.textContent=n||""),alert("❌ "+o.message)}finally{e.target.value=""}}function He(){const e=document.getElementById("trip-image-preview"),t=document.getElementById("trip-image").value.trim();e&&(e.innerHTML=t?`<img src="${c(t)}" alt="Trip image preview" onerror="this.style.display='none'" />`:"")}function Dt(e){return e==="On Trip"?"confirmed":e==="Completed"?"cancelled":"pending"}function Nt(){const e=document.getElementById("trips-tbody"),t=document.getElementById("trips-count-note");if(!e)return;if(!l.trips.length){e.innerHTML='<tr><td colspan="6" style="text-align:center;color:var(--text-muted);padding:24px;">No trips posted yet.</td></tr>',t&&(t.textContent="");return}const a=l.trips.filter(n=>n.busListed&&n.status!=="Completed").length;t&&(t.textContent=`${a} of ${l.trips.length} showing in the app`),e.innerHTML=l.trips.map(n=>`
    <tr>
      <td>
      ...
      <td>
        <span class="badge-status ${Dt(n.status)}">${c(n.status)}</span>
...
Status: ${o.status}`)}catch(n){alert("❌ "+n.message)}}window.deleteTrip=async function(e){if(confirm("Remove this trip from the traveller app?"))try{if(!(await fetch(`${h}/trips/${e}`,{method:"DELETE"})).ok)throw new Error("Failed to delete trip");await J()}catch(t){alert("❌ "+t.message)}};async function Z(){var t;const e=(t=l.currentUser)==null?void 0:t.operatorName;if(e)try{const[a,n]=await Promise.all([fetch(`${h}/subscriptions/plans`),fetch(`${h}/subscriptions?operatorName=${encodeURIComponent(e)}`)]);if(!a.ok||!n.ok)throw new Error("Failed to load subscription data");if(l.plans=await a.json(),l.subscription=await n.json(),l.currentUser.role==="superadmin"){const o=await fetch(`${h}/subscriptions/overview`);o.ok&&(l.agencySubs=await o.json())}At()}catch(a){console.error("Subscription load error:",a)}}function y(e){var n;const t=((n=l.plans)==null?void 0:n.currencySymbol)||"₹",a=Number(e||0);return(a<0?"-":"")+t+Math.abs(a).toLocaleString("en-IN")}function B(e){return e?new Date(e).toLocaleDateString("en-IN",{day:"numeric",month:"short",year:"numeric"}):"—"}function V(e){var n;const t=((n=l.plans)==null?void 0:n.fleetTiers)||[],a=Math.max(1,Number(e)||0);return t.find(o=>a>=o.minVehicles&&(o.maxVehicles===null||a<=o.maxVehicles))||t[t.length-1]||null}function I(){return l.vehicles.length}function z(){var e;return((e=l.subscription)==null?void 0:e.fleet)||null}function fe(){var e;return((e=z())==null?void 0:e.status)==="active"}function je({title:e,lead:t,planName:a,planSub:n,planPrice:o,lines:i=[],total:r,note:s,actionLabel:d}){return new Promise(u=>{const v=document.getElementById("payment-modal");if(!v)return u(!0);document.getElementById("payment-title").textContent=e,document.getElementById("payment-lead").textContent=t||"",document.getElementById("payment-plan").innerHTML=`
      ...
      </div>`,document.getElementById("payment-lines").innerHTML=i.map(b=>`<div><dt>${c(b.label)}</dt><dd>${b.value}</dd></div>`).join(""),document.getElementById("payment-total").textContent=r,document.getElementById("payment-note").textContent=s||"No card is charged yet — the payment gateway is being connected. Confirming records this payment against your agency.";const p=document.getElementById("payment-confirm");p.textContent=d||"Pay & Continue";const m=b=>{v.classList.add("hidden"),p.removeEventListener("click",f),document.getElementById("payment-cancel").removeEventListener("click",g),document.getElementById("payment-close").removeEventListener("click",g),u(b)},f=()=>m(!0),g=()=>m(!1);p.addEventListener("click",f),document.getElementById("payment-cancel").addEventListener("click",g),document.getElementById("payment-close").addEventListener("click",g),v.classList.remove("hidden")})}function P({icon:e="✅",title:t,lead:a,lines:n=[],actionLabel:o="Done"}){return new Promise(i=>{const r=document.getElementById("notice-modal");if(!r)return alert(`${t}

${a||""}`),i();document.getElementById("notice-icon").textContent=e,document.getElementById("notice-title").textContent=t,document.getElementById("notice-lead").textContent=a||"",document.getElementById("notice-lines").innerHTML=n.map(u=>`<div><dt>${c(u.label)}</dt><dd>${u.value}</dd></div>`).join("");const s=document.getElementById("notice-ok");s.textContent=o;const d=()=>{r.classList.add("hidden"),s.removeEventListener("click",d),i()};s.addEventListener("click",d),r.classList.remove("hidden")})}function Ue(){const e=V(I()+1);if(!e)return null;const t=z();return!t||t.status!=="active"?{tier:e,charge:e.price,upgrade:!1}:t.tierId===e.tierId?{tier:e,charge:0,upgrade:!1}:{tier:e,charge:Math.max(0,e.price-(t.price||0)),upgrade:!0}}function T(){var e;return((e=l.plans)==null?void 0:e.billingPeriod)||"month"}function ye(){var e,t;return((t=(e=l.subscription)==null?void 0:e.platform)==null?void 0:t.status)==="active"}function At(){l.plans&&(Pt(),Ot(),Ft(),Ht(),jt(),Ut())}function Pt(){var g;const e=l.plans.platform,t=(g=l.subscription)==null?void 0:g.platform,a=ye(),n=window.location.origin.includes("3005")?"http://localhost:3000/":window.location.origin+"/";document.getElementById("membership-title").textContent=e.name;const o=e.plans||[],i=o.find(b=>b.id===(t==null?void 0:t.planId)),r=o.reduce((b,k)=>b&&b.price<=k.price?b:k,o[0]),s=i||r;document.getElementById("membership-price").textContent=s?`${y(s.price)} / ${s.period}`:y(e.price);const d=document.querySelector(".membership-price-label");d&&(d.textContent=i?"Your platform plan":"Platform fee from"),document.getElementById("membership-benefits").innerHTML=e.features.map(b=>`<li>${c(b)}</li>`).join("");const u=document.getElementById("membership-badge"),v=document.getElementById("membership-card"),p=document.getElementById("membership-status-line"),m=document.getElementById("membership-managed-note");v.classList.toggle("is-active",a),document.getElementById("membership-start").textContent=B(t==null?void 0:t.startsAt),document.getElementById("membership-expiry").textContent=B(t==null?void 0:t.expiresAt),document.getElementById("membership-remaining").textContent=t&&a?`${t.daysLeft} days`:"—",document.getElementById("membership-paid").textContent=t?y(t.amount):"—",a?(u.className="badge-status confirmed",u.textContent="ACTIVE",p.textContent=`${l.subscription.operatorName} is registered. You can add vehicles and browse other agencies' fleets.`,m.innerHTML=`🔒 Managed on the Tripnix site — renew at <a href="${n}" target="_blank" rel="noopener">${n}</a> before it expires.`):t?(u.className="badge-status cancelled",u.textContent="EXPIRED",p.textContent="Your membership has lapsed, so your fleet is hidden from travellers.",m.innerHTML=`⚠️ Renew on the Tripnix site to go live again: <a href="${n}" target="_blank" rel="noopener">${n}</a>`):(u.className="badge-status pending",u.textContent="NOT REGISTERED",p.textContent=e.tagline,m.innerHTML=`⚠️ Pay the platform fee on the Tripnix site to activate your agency: <a href="${n}" target="_blank" rel="noopener">${n}</a>`);const f=document.getElementById("subscription-badge");f&&(f.style.display=a?"none":"inline-block")}function Ft(){var n;const e=l.plans?document.getElementById("plan-grid"):null;if(!e)return;const t=l.plans.fleetTiers||[];if(!t.length){e.innerHTML='<p class="plan-empty">No fleet plan configured.</p>';return}const a=(n=V(I()))==null?void 0:n.id;e.innerHTML=`
    ...
    </div>`}function Ot(){var n,o,i,r;const e=document.getElementById("platform-plan-options");if(!e)return;const t=((o=(n=l.plans)==null?void 0:n.platform)==null?void 0:o.plans)||[];if(!t.length){e.innerHTML="";return}const a=(r=(i=l.subscription)==null?void 0:i.platform)==null?void 0:r.planId;e.innerHTML=t.map(s=>`
    ...
    </div>`).join("")}function Ht(){const e=document.getElementById("listings-tbody"),t=document.getElementById("listing-total-note");if(!e)return;if(!l.vehicles.length){e.innerHTML='<tr><td colspan="7" style="text-align:center;color:var(--text-muted);padding:24px;">No vehicles in your fleet yet.</td></tr>',t.textContent="";return}const a=z(),n=fe(),o=V(I()),i=n?'<span class="badge-status confirmed">LISTED</span>':a?'<span class="badge-status cancelled">EXPIRED</span>':'<span class="badge-status pending">UNPAID</span>';e.innerHTML=l.vehicles.map(d=>`
    <tr>
    ...
    </tr>`).join("")}function Ut(){const e=ye();re.title=e?"Add a vehicle to your fleet":"Pay the platform fee first to start adding vehicles",re.classList.toggle("btn-locked",!e)}window.payFleetFee=async function(){var o,i;const e=(o=l.currentUser)==null?void 0:o.operatorName;if(!e)return;const t=V(I());if(!t)return alert("❌ No fleet plan is configured.");const a=fe();if(await je({title:a?"Renew Fleet Plan":"Confirm Payment",lead:a?`Extends your fleet plan by another ${T()} from its current expiry.`:"One fee covers every vehicle you run — priced by how many that is.",planName:`${t.label} fleet plan`,planSub:`Covers all ${I()} of your vehicle${I()===1?"":"s"}`,planPrice:y(t.price),lines:[{label:"Plan price",value:`${y(t.price)} / ${T()}`},{label:"Vehicles covered",value:String(I())},...a?[{label:"Extends from",value:B((i=z())==null?void 0:i.expiresAt)}]:[]],total:y(t.price),actionLabel:a?`Renew · ${y(t.price)}`:`Pay ${y(t.price)}`}))try{const r=await fetch(`${h}/subscriptions/fleet`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({operatorName:e,vehicleCount:I()})}),s=await r.json();if(!r.ok)throw new Error((s==null?void 0:s.error)||"Payment failed");await Z(),j(),Oe(),await P({icon:a?"🔄":"🎉",title:a?"Fleet plan renewed":"Your fleet is listed!",lead:a?"Your vehicles stay visible to travellers for another period.":"Every vehicle in your fleet is now visible to travellers.",lines:[{label:"Fleet plan",value:c(s.tierLabel)},{label:"Vehicles covered",value:String(I())},{label:"Paid now",value:y(t.price)},{label:"Covered until",value:B(s.expiresAt)}]})}catch(r){alert("❌ "+r.message)}};async function Rt(e){e.preventDefault();const t=Number(document.getElementById("price-platform").value),a=[...document.querySelectorAll("#tier-price-inputs input[data-tier-id]")].map(n=>({id:n.dataset.tierId,price:Number(n.value)}));try{const n=await fetch(`${h}/subscriptions/plans`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({platformPrice:t,fleetTiers:a})}),o=await n.json();if(!n.ok)throw new Error((o==null?void 0:o.error)||"Failed to save pricing");await Z(),alert("✅ Plan pricing updated.")}catch(n){alert("❌ "+n.message)}}async function Q(){var e;if(((e=l.currentUser)==null?void 0:e.role)==="superadmin")try{const t=await fetch(`${h}/auth/admins`);if(!t.ok)throw new Error("Failed");l.admins=await t.json(),zt()}catch(t){console.error("Admins load error:",t)}}async function Vt(e){e.preventDefault();const t=document.getElementById("admin-username").value.trim(),a=document.getElementById("admin-password").value.trim(),n=document.getElementById("admin-operator").value.trim(),o=document.getElementById("admin-phone").value.trim();try{const i=await fetch(`${h}/auth/admins`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:t,password:a,operatorName:n,phone:o})});let r=null;try{r=await i.json()}catch{r=null}if(!i.ok)throw new Error((r==null?void 0:r.error)||"Failed to create account");ie.reset(),await Q(),alert(`✅ Account created!

Travel Agency: ${n}
Username: ${t}
Password: ${a}

Share these credentials with the travel owner.`)}catch(i){alert("❌ "+i.message)}}function zt(){const e=document.getElementById("admins-table-tbody");if(e){if(!l.admins.length){e.innerHTML='<tr><td colspan="7" style="text-align:center;color:var(--text-muted);padding:24px;">No travel owner accounts yet.</td></tr>';return}e.innerHTML=l.admins.map(t=>`
    <tr>
      <td>#${t.id}</td>
    ...
    <div class="vehicle-admin-card${a.onHold?" is-held":""}">
    ...
    </div>`}).join("")}function Yt(){const e=document.getElementById("all-bookings-tbody"),t=[...l.bookings].reverse();e.innerHTML=t.length?t.map(a=>`
      <tr>
        <td>#${a.id}</td>
      ...
      </tr>`).join(""):'<tr><td colspan="7" style="text-align:center;color:var(--text-muted);padding:32px;">No bookings found.</td></tr>'}let $=null;function Wt(){const e=document.getElementById("vehicle-dates");e&&typeof flatpickr<"u"&&!$&&($=flatpickr(e,{mode:"multiple",dateFormat:"Y-m-d",conjunction:", ",theme:"dark",monthSelectorType:"dropdown",onChange:t=>{X(t)}}),Kt())}function X(e){const t=document.getElementById("selected-date-chips"),a=document.getElementById("selected-dates-count");if(!t)return;const n=(e||[]).map(o=>{if(o instanceof Date){const i=o.getFullYear(),r=String(o.getMonth()+1).padStart(2,"0"),s=String(o.getDate()).padStart(2,"0");return`${i}-${r}-${s}`}return String(o).trim()}).filter(Boolean).sort();if(a&&(a.textContent=`${n.length} date${n.length===1?"":"s"} selected`),n.length===0){t.innerHTML='<span class="no-dates-text">No dates selected yet. Click input or presets above to select dates.</span>';return}t.innerHTML=n.map(o=>`
  ...
  `).join(""),t.querySelectorAll(".chip-remove").forEach(o=>{o.addEventListener("click",i=>{i.stopPropagation();const r=o.getAttribute("data-date");Gt(r)})})}function Gt(e){if(!$)return;const a=$.selectedDates.filter(n=>{const o=n.getFullYear(),i=String(n.getMonth()+1).padStart(2,"0"),r=String(n.getDate()).padStart(2,"0");return`${o}-${i}-${r}`!==e});$.setDate(a,!0)}function Kt(){var e,t,a,n,o;(e=document.getElementById("preset-today"))==null||e.addEventListener("click",()=>{const i=new Date;$==null||$.setDate([i],!0)}),(t=document.getElementById("preset-next-7"))==null||t.addEventListener("click",()=>{const i=[],r=new Date;for(let s=0;s<7;s++){const d=new Date(r);d.setDate(r.getDate()+s),i.push(d)}$==null||$.setDate(i,!0)}),(a=document.getElementById("preset-next-14"))==null||a.addEventListener("click",()=>{const i=[],r=new Date;for(let s=0;s<14;s++){const d=new Date(r);d.setDate(r.getDate()+s),i.push(d)}$==null||$.setDate(i,!0)}),(n=document.getElementById("preset-clear"))==null||n.addEventListener("click",()=>{$==null||$.clear(),X([])}),(o=document.getElementById("open-calendar-btn"))==null||o.addEventListener("click",()=>{$==null||$.open()})}function Re(e=null){var r;l.editingVehicleId=(e==null?void 0:e.id)??null,nt.textContent=e?"Edit Vehicle":"Add New Vehicle";const t=document.getElementById("modal-save-btn");t&&(t.textContent=e?"Update Vehicle":"Add Vehicle");const a=((r=l.currentUser)==null?void 0:r.operatorName)??"",n=(e==null?void 0:e.type)??"Bus";document.getElementById("vehicle-id").value=(e==null?void 0:e.id)??"",document.getElementById("vehicle-type").value=n,document.getElementById("vehicle-operator").value=(e==null?void 0:e.operatorName)??a,document.getElementById("vehicle-name").value=(e==null?void 0:e.name)??"",document.getElementById("vehicle-number").value=(e==null?void 0:e.vehicleNumber)??"",document.getElementById("vehicle-capacity").value=(e==null?void 0:e.capacity)??36,document.getElementById("vehicle-description").value=(e==null?void 0:e.description)??"",document.getElementById("vehicle-instagram").value=(e==null?void 0:e.instagramUrl)??"",window.syncCustomTypeDropdown&&window.syncCustomTypeDropdown(n),l.vehicleFormImages=Array.isArray(e==null?void 0:e.imageUrls)?[...e.imageUrls]:[],l.vehicleFormVideos=Array.isArray(e==null?void 0:e.videoUrls)?[...e.videoUrls]:[],R();const o=(e==null?void 0:e.features)??["AC","WiFi"];document.querySelectorAll(".features-checkboxes input").forEach(s=>{s.checked=o.includes(s.value)}),Wt();const i=(e==null?void 0:e.availableDates)??[];$?($.setDate(i,!1),X($.selectedDates)):document.getElementById("vehicle-dates").value=i.join(", "),U(),Se.classList.remove("hidden")}function U(){const e=document.getElementById("vehicle-sub-panel");if(!e||!l.plans)return;const t=!!l.editingVehicleId,a=document.getElementById("vehicle-sub-tier-label"),n=document.getElementById("vehicle-sub-tier-seats"),o=document.getElementById("vehicle-sub-price"),i=document.getElementById("vehicle-sub-note"),r=document.getElementById("modal-save-btn");if(t){const d=z(),u=V(I());e.classList.remove("is-invalid"),r.disabled=!1,a.textContent=u?`${u.label} fleet plan`:"Fleet plan",n.textContent=`${I()} vehicle${I()===1?"":"s"} covered`,o.textContent=u?`${y(u.price)}/${T()}`:"—",i.textContent=(d==null?void 0:d.status)==="active"?`Covered until ${B(d.expiresAt)}. Updating these details does not change the fee.`:"Updating these details does not change the fee. Pay it from the Subscription page.",r.textContent="Update Vehicle";return}const s=Ue();if(!s){e.classList.add("is-invalid"),a.textContent="No fleet plan configured",n.textContent="",o.textContent="—",i.textContent="No fleet plan is configured. Ask the Super Admin to set one on the Subscription page.",r.textContent="Add Vehicle",r.disabled=!0;return}e.classList.remove("is-invalid"),r.disabled=!1,a.textContent=`${s.tier.label} fleet plan`,n.textContent=`This would be vehicle #${I()+1}`,o.textContent=`${y(s.tier.price)}/${T()}`,s.charge===0?i.textContent=`Your ${s.tier.label} plan (${y(s.tier.price)}/${T()}) already covers this vehicle — nothing more to pay. It goes live in the app straight after.`:s.upgrade?i.textContent=`This vehicle moves your fleet onto the ${s.tier.label} plan at ${y(s.tier.price)}/${T()}. You have already paid ${y(s.tier.price-s.charge)} of it, so ${y(s.charge)} is payable now and your renewal date does not change.`:i.textContent=`Adding this vehicle starts your ${s.tier.label} plan at ${y(s.tier.price)} for one ${T()}, covering every vehicle you add inside that band.`,r.textContent=s.charge>0?`Add Vehicle · ${y(s.charge)}`:"Add Vehicle"}function G(){$&&$.clear(),X([]),l.vehicleFormImages=[],l.vehicleFormVideos=[],R(),window.syncCustomTypeDropdown&&window.syncCustomTypeDropdown("Bus"),Se.classList.add("hidden"),De.reset()}async function _t(e){e.preventDefault();const t=l.editingVehicleId,a=document.getElementById("vehicle-name").value.trim(),n=document.getElementById("vehicle-number").value.trim().toUpperCase(),o=document.getElementById("vehicle-type").value,i=document.getElementById("vehicle-operator").value.trim(),r=Number(document.getElementById("vehicle-capacity").value),s=document.getElementById("vehicle-description").value.trim(),d=document.getElementById("vehicle-instagram").value.trim();let u=[];$&&$.selectedDates.length>0?u=$.selectedDates.map(w=>{const L=w.getFullYear(),S=String(w.getMonth()+1).padStart(2,"0"),E=String(w.getDate()).padStart(2,"0");return`${L}-${S}-${E}`}).sort():u=document.getElementById("vehicle-dates").value.split(",").map(w=>w.trim()).filter(Boolean);const v=l.vehicleFormImages,p=l.vehicleFormVideos,m=[...document.querySelectorAll(".features-checkboxes input:checked")].map(w=>w.value),f={name:a,type:o,vehicleNumber:n,operatorName:i,capacity:r,description:s,instagramUrl:d,availableDates:u,imageUrls:v,videoUrls:p,features:m},g=t?null:Ue();if(!t&&!g)return alert("❌ No fleet plan is configured, so this vehicle cannot be listed yet.");if(g&&g.charge>0){const w=g.tier.price-g.charge;if(!await je({title:g.upgrade?"Upgrade Fleet Plan":"Confirm Payment",lead:g.upgrade?`Adding ${a} takes your fleet to ${I()+1} vehicles, which moves you onto the ${g.tier.label} plan.`:`Adding ${a} starts your fleet plan. One fee covers every vehicle in the band.`,planName:`${g.tier.label} fleet plan`,planSub:`Covers ${I()+1} vehicle${I()+1===1?"":"s"}`,planPrice:y(g.tier.price),lines:[{label:"Plan price",value:`${y(g.tier.price)} / ${T()}`},...w>0?[{label:"Already paid this period",value:`− ${y(w)}`}]:[],{label:"Billing period",value:T()}],total:y(g.charge),actionLabel:`Pay ${y(g.charge)} & Add`}))return}const b=document.getElementById("modal-save-btn"),k=b.textContent;b.disabled=!0,b.textContent="Saving…";try{const w=t?`${h}/vehicles/${t}`:`${h}/vehicles`,S=await fetch(w,{method:t?"PUT":"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(f)});let E=null;try{E=await S.json()}catch{E=null}if(!S.ok)throw new Error((E==null?void 0:E.error)||"Failed to save vehicle");if(t)return G(),await D(),P({icon:"✏️",title:`${a} updated`,lead:"The details are saved. Your fleet plan and renewal date are unchanged."});if(G(),await D(),!E.fleet)return P({icon:"⚠️",title:`${a} saved, but not listed`,lead:E.listingWarning||"The fleet fee could not be charged, so your vehicles are not visible to travellers yet. Pay it from the Subscription page.",actionLabel:"Got it"});const N=Number(E.fleet.charge||0);return P({icon:"🎉",title:`${a} is live in the app!`,lead:`Travellers can now see it. Your fleet plan covers every vehicle in the ${E.fleet.tierLabel} band.`,lines:[{label:"Fleet plan",value:c(E.fleet.tierLabel)},{label:"Vehicles covered",value:String(E.fleet.vehicleCount??I())},{label:"Paid now",value:N>0?y(N)+(E.fleet.upgraded?" (upgrade)":""):"Nothing — already covered"},{label:"Covered until",value:B(E.fleet.expiresAt)}]})}catch(w){alert("❌ "+w.message)}finally{b.disabled=!1,b.textContent=k}}window.editVehicle=function(e){const t=l.vehicles.find(a=>a.id===e);t&&Re(t)};function Ve(e){const t=new Date(`${e}T00:00:00`);if(Number.isNaN(t.getTime()))return 0;const a=Date.UTC(t.getFullYear(),t.getMonth(),t.getDate()),n=new Date,o=Date.UTC(n.getFullYear(),n.getMonth(),n.getDate());return Math.max(1,Math.round((o-a)/864e5)+1)}window.holdVehicle=async function(e){const t=l.vehicles.find(n=>n.id===e);if(!t)return;const a=prompt(`Hold "${t.name}" off the app?
